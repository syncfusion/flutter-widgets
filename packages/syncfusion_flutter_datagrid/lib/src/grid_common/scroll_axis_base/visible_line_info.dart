...
class _VisibleLineInfo extends Comparable<_VisibleLineInfo> {
  ...
  _VisibleLineInfo(int visibleIndex, this.lineIndex, double size,
  ...
  /// Initializes a new instance of the [_VisibleLineInfo] class.
  /// Used for BinarySearch.
  ///
  /// * clippedOrigin - _required_ - The clipped origin.
  _VisibleLineInfo.fromClippedOrigin(double clippedOrigin) {
    _clippedOrigin = clippedOrigin;
  }
  ...
  _VisibleLineInfo.fromLineIndex(this.lineIndex);
  ...
  bool get isVisible => _visibleIndex != _MathHelper.maxvalue;
  ...
  _ScrollAxisRegion get region {
    if (_isHeader) {
      return _ScrollAxisRegion.header;
    } else if (_isFooter) {
      return _ScrollAxisRegion.footer;
    }

    return _ScrollAxisRegion.body;
  }
  ...
  @override
  int compareTo(_VisibleLineInfo other) =>
...
class _VisibleLinesCollection extends ListBase<_VisibleLineInfo> {
  ...
  bool anyVisibleLines(int lineIndex1, int lineIndex2) {
    ...
    for (int n = 0; n < length; n++) {
      final _VisibleLineInfo line = this[n];
  ...
  @override
  void operator []=(int index, _VisibleLineInfo value) {
...
class _VisibleLineInfoLineIndexComparer extends Comparable<_VisibleLineInfo> {
  ...
  /// given visible lines.
  int compare(_VisibleLineInfo x, _VisibleLineInfo y) =>
