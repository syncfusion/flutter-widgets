...
/// Test method for date time axis of the stacked column series.
void stackedColumnDateTimeAxis() {
  ...
  group('Column Date Time - Range and Range Padding', () {
    testWidgets('DateTime axis - Default', (WidgetTester tester) async {
      final _StackedColumnDateTime chartContainer =
          _stackedColumnDateTime('datetime_default') as _StackedColumnDateTime;
    ...
    //   final _StackedColumnDateTime chartContainer =
    //       _stackedColumnDateTime('datetime_range') as _StackedColumnDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    ...
    //   final _StackedColumnDateTime chartContainer =
    //       _stackedColumnDateTime('datetime_rangepadding_add')
    //           as _StackedColumnDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //     (WidgetTester tester) async {
    //   final _StackedColumnDateTime chartContainer =
    //       _stackedColumnDateTime('datetime_rangepadding_normal')
    //           as _StackedColumnDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    //     (WidgetTester tester) async {
    //   final _StackedColumnDateTime chartContainer =
    //       _stackedColumnDateTime('datetime_rangepadding_round')
    //           as _StackedColumnDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    //     (WidgetTester tester) async {
    //   final _StackedColumnDateTime chartContainer =
    //       _stackedColumnDateTime('datetime_rangepadding_none')
    //           as _StackedColumnDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    //     (WidgetTester tester) async {
    //   final _StackedColumnDateTime chartContainer =
    //       _stackedColumnDateTime('datetime_rangepadding_auto')
    //           as _StackedColumnDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  group('Column Date Time - Grids, Ticks and Axis Elements', () {
    ...
    //     (WidgetTester tester) async {
    //   final _StackedColumnDateTime chartContainer =
    //       _stackedColumnDateTime('datetime_edgelabelPlacement_hide')
    //           as _StackedColumnDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    testWidgets('DateTime Axis - Axis Line and Title',
        (WidgetTester tester) async {
      final _StackedColumnDateTime chartContainer =
          _stackedColumnDateTime('datetime_axisLine_title')
              as _StackedColumnDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    //   final _StackedColumnDateTime chartContainer =
    //       _stackedColumnDateTime('datetime_inversed') as _StackedColumnDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _StackedColumnDateTime chartContainer =
    //       _stackedColumnDateTime('datetime_opposed') as _StackedColumnDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('DateTime Axis - Major Grid and Tick lines',
        (WidgetTester tester) async {
      final _StackedColumnDateTime chartContainer =
          _stackedColumnDateTime('datetime_gridlines')
              as _StackedColumnDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    //   final _StackedColumnDateTime chartContainer =
    //       _stackedColumnDateTime('datetime_labelStyle')
    //           as _StackedColumnDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    //   final _StackedColumnDateTime chartContainer =
    //       _stackedColumnDateTime('datetime_axisVisible')
    //           as _StackedColumnDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
...
StatelessWidget _stackedColumnDateTime(String sampleName) {
  return _StackedColumnDateTime(sampleName);
}

// ignore: must_be_immutable
class _StackedColumnDateTime extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _StackedColumnDateTime(String sampleName) {
