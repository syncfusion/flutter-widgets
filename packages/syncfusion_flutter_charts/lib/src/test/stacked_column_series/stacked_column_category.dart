...
/// Test method of category axis of the stacked column series.
void stackedColumnCategoryAxis() {
  ...
  group('Stacked Line Category - Defualt Properties', () {
    testWidgets('Category axis - Default', (WidgetTester tester) async {
      final _StackedColumnCategory chartContainer =
          _stackedColumnCategory('category_default') as _StackedColumnCategory;
...
// to test series count
    ...
    //   final _StackedColumnCategory chartContainer =
    //       _stackedColumnCategory('category_labelPlacement')
    //           as _StackedColumnCategory;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
  ...
  group('Bar Category - Axis Elements', () {
    testWidgets('Category axis - EdgeLabelPlacement',
      ...
      final _StackedColumnCategory chartContainer =
          _stackedColumnCategory('category_EdgeLabelPlacement')
              as _StackedColumnCategory;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    //   final _StackedColumnCategory chartContainer =
    //       _stackedColumnCategory('category_inversed') as _StackedColumnCategory;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _StackedColumnCategory chartContainer =
    //       _stackedColumnCategory('category_opposed') as _StackedColumnCategory;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('Category Axis - Label and Tick Position',
        (WidgetTester tester) async {
      final _StackedColumnCategory chartContainer =
          _stackedColumnCategory('category_label_tickPosition')
              as _StackedColumnCategory;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('Category Axis - Major Grid and Tick lines',
        (WidgetTester tester) async {
      final _StackedColumnCategory chartContainer =
          _stackedColumnCategory('category_gridlines')
              as _StackedColumnCategory;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    //   final _StackedColumnCategory chartContainer =
    //       _stackedColumnCategory('category_labelStyle')
    //           as _StackedColumnCategory;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    testWidgets('Category Axis - Visibility', (WidgetTester tester) async {
      final _StackedColumnCategory chartContainer =
          _stackedColumnCategory('category_axisVisible')
              as _StackedColumnCategory;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('Category Axis - Axis Line', (WidgetTester tester) async {
      final _StackedColumnCategory chartContainer =
          _stackedColumnCategory('category_axisLine_title')
              as _StackedColumnCategory;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
...
StatelessWidget _stackedColumnCategory(String sampleName) {
  return _StackedColumnCategory(sampleName);
}

// ignore: must_be_immutable
class _StackedColumnCategory extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _StackedColumnCategory(String sampleName) {
