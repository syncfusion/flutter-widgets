...
/// Test method for date time axis of the stacked column 100 series.
void stackedColumn100DateTimeAxis() {
  ...
  group('Column Date Time - Range and Range Padding', () {
    testWidgets('DateTime axis - Default', (WidgetTester tester) async {
      final _StackedColumn100DateTime chartContainer =
          _stackedColumn100DateTime('datetime_default')
              as _StackedColumn100DateTime;
    ...
    //   final _StackedColumn100DateTime chartContainer =
    //       _stackedColumn100DateTime('datetime_range')
    //           as _StackedColumn100DateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    ...
    //   final _StackedColumn100DateTime chartContainer =
    //       _stackedColumn100DateTime('datetime_rangepadding_add')
    //           as _StackedColumn100DateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    //     (WidgetTester tester) async {
    //   final _StackedColumn100DateTime chartContainer =
    //       _stackedColumn100DateTime('datetime_rangepadding_normal')
    //           as _StackedColumn100DateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    //     (WidgetTester tester) async {
    //   final _StackedColumn100DateTime chartContainer =
    //       _stackedColumn100DateTime('datetime_rangepadding_round')
    //           as _StackedColumn100DateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    //     (WidgetTester tester) async {
    //   final _StackedColumn100DateTime chartContainer =
    //       _stackedColumn100DateTime('datetime_rangepadding_none')
    //           as _StackedColumn100DateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    //     (WidgetTester tester) async {
    //   final _StackedColumn100DateTime chartContainer =
    //       _stackedColumn100DateTime('datetime_rangepadding_auto')
    //           as _StackedColumn100DateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  group('Column Date Time - Grids, Ticks and Axis Elements', () {
    ...
    //     (WidgetTester tester) async {
    //   final _StackedColumn100DateTime chartContainer =
    //       _stackedColumn100DateTime('datetime_edgelabelPlacement_hide')
    //           as _StackedColumn100DateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    testWidgets('DateTime Axis - Axis Line and Title',
        (WidgetTester tester) async {
      final _StackedColumn100DateTime chartContainer =
          _stackedColumn100DateTime('datetime_axisLine_title')
              as _StackedColumn100DateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    //   final _StackedColumn100DateTime chartContainer =
    //       _stackedColumn100DateTime('datetime_inversed')
    //           as _StackedColumn100DateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    //   final _StackedColumn100DateTime chartContainer =
    //       _stackedColumn100DateTime('datetime_opposed')
    //           as _StackedColumn100DateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    testWidgets('DateTime Axis - Major Grid and Tick lines',
        (WidgetTester tester) async {
      final _StackedColumn100DateTime chartContainer =
          _stackedColumn100DateTime('datetime_gridlines')
              as _StackedColumn100DateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    //   final _StackedColumn100DateTime chartContainer =
    //       _stackedColumn100DateTime('datetime_labelStyle')
    //           as _StackedColumn100DateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    //   final _StackedColumn100DateTime chartContainer =
    //       _stackedColumn100DateTime('datetime_axisVisible')
    //           as _StackedColumn100DateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
...
StatelessWidget _stackedColumn100DateTime(String sampleName) {
  return _StackedColumn100DateTime(sampleName);
}

// ignore: must_be_immutable
class _StackedColumn100DateTime extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _StackedColumn100DateTime(String sampleName) {
