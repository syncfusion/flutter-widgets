...
/// Test method for markers in the stacked column 100 series.
void stackedColumn100Marker() {
  ...
  group('Stacked Column - Marker', () {
    testWidgets('Chart Widget - Testing StackedColumn Series with Marker',
      ...
      final _StackedColumn100Marker chartContainer =
          _stackedColumn100Marker('marker_default') as _StackedColumn100Marker;
    ...
    testWidgets('Chart Widget - Testing Column Sries with Marker Customization',
        (WidgetTester tester) async {
      final _StackedColumn100Marker chartContainer =
          _stackedColumn100Marker('marker_cutomization')
              as _StackedColumn100Marker;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('Chart Widget - Testing Column series Makrer with Empty Point',
        (WidgetTester tester) async {
      final _StackedColumn100Marker chartContainer =
          _stackedColumn100Marker('marker_EmptyPoint')
              as _StackedColumn100Marker;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
...
// Column series with marker
    testWidgets('Chart Widget - Rectangle Marker', (WidgetTester tester) async {
      final _StackedColumn100Marker chartContainer =
          _stackedColumn100Marker('marker_rect') as _StackedColumn100Marker;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('Chart Widget - Pentagon Marker', (WidgetTester tester) async {
      final _StackedColumn100Marker chartContainer =
          _stackedColumn100Marker('marker_pentagon') as _StackedColumn100Marker;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('Chart Widget - Vertical Line Marker',
        (WidgetTester tester) async {
      final _StackedColumn100Marker chartContainer =
          _stackedColumn100Marker('marker_verticalLine')
              as _StackedColumn100Marker;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('Chart Widget - Invertical Triangle Marker',
        (WidgetTester tester) async {
      final _StackedColumn100Marker chartContainer =
          _stackedColumn100Marker('marker_invertTriangle')
              as _StackedColumn100Marker;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('Chart Widget - Triangle Marker', (WidgetTester tester) async {
      final _StackedColumn100Marker chartContainer =
          _stackedColumn100Marker('marker_triangle') as _StackedColumn100Marker;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
...
StatelessWidget _stackedColumn100Marker(String sampleName) {
  return _StackedColumn100Marker(sampleName);
}

// ignore: must_be_immutable
class _StackedColumn100Marker extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _StackedColumn100Marker(String sampleName) {
