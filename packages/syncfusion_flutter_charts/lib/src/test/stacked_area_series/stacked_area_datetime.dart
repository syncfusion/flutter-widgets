...
/// Test method for date time axis of the stacked area series.
void stackedAreaDateTimeAxis() {
  ...
  group('Stacked Area Date Time Axis - Defualt Properties', () {
    testWidgets('DateTime axis - Default', (WidgetTester tester) async {
      final _StackedAreaDateTime chartContainer =
          _stackedAreaDateTime('datetime_default') as _StackedAreaDateTime;
  ...
  // group('Stacked Area DateTime Range', () {
  //   testWidgets('Datetime axis - With Range', (WidgetTester tester) async {
  //     final _StackedAreaDateTime chartContainer =
  //         _stackedAreaDateTime('datetime_range') as _StackedAreaDateTime;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  ...
  // group('Stacked Area DateTime - Range Padding', () {
  //   testWidgets('Datetime axis - RangePadding Additional',
  //       (WidgetTester tester) async {
  //     final _StackedAreaDateTime chartContainer =
  //         _stackedAreaDateTime('datetime_rangepadding_add')
  //             as _StackedAreaDateTime;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  //       (WidgetTester tester) async {
  //     final _StackedAreaDateTime chartContainer =
  //         _stackedAreaDateTime('datetime_rangepadding_normal')
  //             as _StackedAreaDateTime;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  //     (WidgetTester tester) async {
  //   final _StackedAreaDateTime chartContainer =
  //       _stackedAreaDateTime('datetime_rangepadding_round')
  //           as _StackedAreaDateTime;
  //   await tester.pumpWidget(chartContainer);
  //   chart = chartContainer.chart;
  //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  // testWidgets('Stacked area Datetime axis - RangePadding Round',
  //     (WidgetTester tester) async {
  //   final _StackedAreaDateTime chartContainer =
  //       _stackedAreaDateTime('datetime_rangepadding_none')
  //           as _StackedAreaDateTime;
  //   await tester.pumpWidget(chartContainer);
  //   chart = chartContainer.chart;
  //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  // testWidgets('Stacked area Datetime axis - RangePadding Auto',
  //     (WidgetTester tester) async {
  //   final _StackedAreaDateTime chartContainer =
  //       _stackedAreaDateTime('datetime_rangepadding_auto')
  //           as _StackedAreaDateTime;
  //   await tester.pumpWidget(chartContainer);
  //   chart = chartContainer.chart;
  //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  // group('Stacked area Date Time- Edge Label Placement ', () {
  //   testWidgets('DateTime axis - EdgeLabelPlacement Hide',
  //       (WidgetTester tester) async {
  //     final _StackedAreaDateTime chartContainer =
  //         _stackedAreaDateTime('datetime_edgelabelPlacement_hide')
  //             as _StackedAreaDateTime;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  group('Stacked area Date Time Axis Elements', () {
    testWidgets('DateTime Axis - Axis Line and Title',
        (WidgetTester tester) async {
      final _StackedAreaDateTime chartContainer =
          _stackedAreaDateTime('datetime_axisLine_title')
              as _StackedAreaDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    //   final _StackedAreaDateTime chartContainer =
    //       _stackedAreaDateTime('datetime_inversed') as _StackedAreaDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    // testWidgets('Stacked area DateTime axis - Opposed',
    //     (WidgetTester tester) async {
    //   final _StackedAreaDateTime chartContainer =
    //       _stackedAreaDateTime('datetime_opposed') as _StackedAreaDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('Stacked area DateTime Axis - Major Grid and Tick lines',
        (WidgetTester tester) async {
      final _StackedAreaDateTime chartContainer =
          _stackedAreaDateTime('datetime_gridlines') as _StackedAreaDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    ...
    testWidgets('Stacked area DateTime Axis - Label Style',
        (WidgetTester tester) async {
      final _StackedAreaDateTime chartContainer =
          _stackedAreaDateTime('datetime_labelStyle') as _StackedAreaDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('DateTime Axis - Visibility', (WidgetTester tester) async {
      final _StackedAreaDateTime chartContainer =
          _stackedAreaDateTime('datetime_axisVisible') as _StackedAreaDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
...
StatelessWidget _stackedAreaDateTime(String sampleName) {
  return _StackedAreaDateTime(sampleName);
}

// ignore: must_be_immutable
class _StackedAreaDateTime extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _StackedAreaDateTime(String sampleName) {
