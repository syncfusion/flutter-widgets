...
/// Test method of category axis of the stacked area series.
void stackedAreaCategoryAxis() {
  ...
  group('Stacked Area Category - Defualt Properties', () {
    testWidgets('Category axis - Default', (WidgetTester tester) async {
      final _StackedAreaCategory chartContainer =
          _stackedAreaCategory('category_default') as _StackedAreaCategory;
...
// to test series count
    ...
    testWidgets('Category axis - LabelPlacement', (WidgetTester tester) async {
      final _StackedAreaCategory chartContainer =
          _stackedAreaCategory('category_labelPlacement')
              as _StackedAreaCategory;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
  ...
  group('Stacked Area Category - Axis Elements', () {
    // testWidgets('Category axis - EdgeLabelPlacement',
    //     (WidgetTester tester) async {
    //   final _StackedAreaCategory chartContainer =
    //       _stackedAreaCategory('category_EdgeLabelPlacement')
    //           as _StackedAreaCategory;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    ...
    //   final _StackedAreaCategory chartContainer =
    //       _stackedAreaCategory('category_inversed') as _StackedAreaCategory;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _StackedAreaCategory chartContainer =
    //       _stackedAreaCategory('category_opposed') as _StackedAreaCategory;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('Category Axis - Label and Tick Position',
        (WidgetTester tester) async {
      final _StackedAreaCategory chartContainer =
          _stackedAreaCategory('category_label_tickPosition')
              as _StackedAreaCategory;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('Category Axis - Major Grid and Tick lines',
        (WidgetTester tester) async {
      final _StackedAreaCategory chartContainer =
          _stackedAreaCategory('category_gridlines') as _StackedAreaCategory;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('Category Axis - Label Style', (WidgetTester tester) async {
      final _StackedAreaCategory chartContainer =
          _stackedAreaCategory('category_labelStyle') as _StackedAreaCategory;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('Category Axis - Visibility', (WidgetTester tester) async {
      final _StackedAreaCategory chartContainer =
          _stackedAreaCategory('category_axisVisible') as _StackedAreaCategory;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('Category Axis - Axis Line', (WidgetTester tester) async {
      final _StackedAreaCategory chartContainer =
          _stackedAreaCategory('category_axisLine_title')
              as _StackedAreaCategory;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('Category Axis - Axis Title', (WidgetTester tester) async {
      final _StackedAreaCategory chartContainer =
          _stackedAreaCategory('category_axisTitle') as _StackedAreaCategory;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
...
StatelessWidget _stackedAreaCategory(String sampleName) {
  return _StackedAreaCategory(sampleName);
}

// ignore: must_be_immutable
class _StackedAreaCategory extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _StackedAreaCategory(String sampleName) {
