...
// /// Testing method of step area series data source.
// void stepAreaDataSource() {
...
//   group('StepArea Series with DataSource', () {
...
//     testWidgets('Chart Widget - Testing StepArea series Data Source',
//         (WidgetTester tester) async {
//       final _StepAreaDataSource chartContainer =
//           _stepAreaDataSource('customization_pointColor')
//               as _StepAreaDataSource;
...
//   group('StepArea Series - Empty points', () {
...
//         (WidgetTester tester) async {
//       final _StepAreaDataSource chartContainer =
//           _stepAreaDataSource('dataSource_emptyPoint_gap')
//               as _StepAreaDataSource;
//       await tester.pumpWidget(chartContainer);
//       chart = chartContainer.chart;
//       final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
...
//         (WidgetTester tester) async {
//       final _StepAreaDataSource chartContainer =
//           _stepAreaDataSource('dataSource_emptyPoint_zero')
//               as _StepAreaDataSource;
//       await tester.pumpWidget(chartContainer);
//       chart = chartContainer.chart;
//       final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
...
//         (WidgetTester tester) async {
//       final _StepAreaDataSource chartContainer =
//           _stepAreaDataSource('dataSource_emptyPoint_avg')
//               as _StepAreaDataSource;
//       await tester.pumpWidget(chartContainer);
//       chart = chartContainer.chart;
//       final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
...
//     pointRegionDrop.add(const Rect.fromLTRB(145.7, 494.5, 161.7, 510.5));
//     pointRegionDrop.add(const Rect.fromLTRB(336.7, 92.1, 352.7, 108.1));
...
//         (WidgetTester tester) async {
//       final _StepAreaDataSource chartContainer =
//           _stepAreaDataSource('dataSource_emptyPoint_drop')
//               as _StepAreaDataSource;
//       await tester.pumpWidget(chartContainer);
//       chart = chartContainer.chart;
//       final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
...
//         (WidgetTester tester) async {
//       final _StepAreaDataSource chartContainer =
//           _stepAreaDataSource('dataSource_emptyPoint_null')
//               as _StepAreaDataSource;
//       await tester.pumpWidget(chartContainer);
//       chart = chartContainer.chart;
//       final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
...
// StatelessWidget _stepAreaDataSource(String sampleName) {
//   return _StepAreaDataSource(sampleName);
// }

// // ignore: must_be_immutable
// class _StepAreaDataSource extends StatelessWidget {
//   // ignore: prefer_const_constructors_in_immutables
//   _StepAreaDataSource(String sampleName) {
//     chart = _getStepAreachart(sampleName);
//   }
//   SfCartesianChart? chart;
