...
/// Test method for date time axis of the step area series.
void stepAreaDateTimeAxis() {
  ...
  group('StepArea - Date Time Axis - Defualt Properties', () {
    testWidgets('DateTime axis - Default', (WidgetTester tester) async {
      final _StepAreaDateTime chartContainer =
          _stepAreaDateTime('datetime_default') as _StepAreaDateTime;
  ...
  // group('StepArea - DateTime Range', () {
  //   testWidgets('Datetime axis - With Range', (WidgetTester tester) async {
  //     final _StepAreaDateTime chartContainer =
  //         _stepAreaDateTime('datetime_range') as _StepAreaDateTime;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  ...
  // group('StepArea - DateTime - Range Padding', () {
  //   testWidgets('Datetime axis - RangePadding Additional',
  //       (WidgetTester tester) async {
  //     final _StepAreaDateTime chartContainer =
  //         _stepAreaDateTime('datetime_rangepadding_add') as _StepAreaDateTime;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  //       (WidgetTester tester) async {
  //     final _StepAreaDateTime chartContainer =
  //         _stepAreaDateTime('datetime_rangepadding_normal')
  //             as _StepAreaDateTime;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  //       (WidgetTester tester) async {
  //     final _StepAreaDateTime chartContainer =
  //         _stepAreaDateTime('datetime_rangepadding_round') as _StepAreaDateTime;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  //       (WidgetTester tester) async {
  //     final _StepAreaDateTime chartContainer =
  //         _stepAreaDateTime('datetime_rangepadding_none') as _StepAreaDateTime;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  //       (WidgetTester tester) async {
  //     final _StepAreaDateTime chartContainer =
  //         _stepAreaDateTime('datetime_rangepadding_auto') as _StepAreaDateTime;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  // group('StepArea - Date Time- Edge Label Placement ', () {
  //   testWidgets('DateTime axis - EdgeLabelPlacement Hide',
  //       (WidgetTester tester) async {
  //     final _StepAreaDateTime chartContainer =
  //         _stepAreaDateTime('datetime_edgelabelPlacement_hide')
  //             as _StepAreaDateTime;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  group('StepArea - Date Time Axis Elements', () {
    testWidgets('DateTime Axis - Axis Line and Title',
        (WidgetTester tester) async {
      final _StepAreaDateTime chartContainer =
          _stepAreaDateTime('datetime_axisLine_title') as _StepAreaDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    //   final _StepAreaDateTime chartContainer =
    //       _stepAreaDateTime('datetime_inversed') as _StepAreaDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _StepAreaDateTime chartContainer =
    //       _stepAreaDateTime('datetime_opposed') as _StepAreaDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('DateTime Axis - Major Grid and Tick lines',
        (WidgetTester tester) async {
      final _StepAreaDateTime chartContainer =
          _stepAreaDateTime('datetime_gridlines') as _StepAreaDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    //   final _StepAreaDateTime chartContainer =
    //       _stepAreaDateTime('datetime_labelStyle') as _StepAreaDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _StepAreaDateTime chartContainer =
    //       _stepAreaDateTime('datetime_axisVisible') as _StepAreaDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
...
StatelessWidget _stepAreaDateTime(String sampleName) {
  return _StepAreaDateTime(sampleName);
}

// ignore: must_be_immutable
class _StepAreaDateTime extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _StepAreaDateTime(String sampleName) {
