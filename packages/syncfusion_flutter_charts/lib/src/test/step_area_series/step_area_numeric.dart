...
/// Test method for numeric axis of the step area series.
void stepAreaNumericAxis() {
  ...
  group('StepArea Series - Numeric Axis Default properties', () {
    testWidgets('Numeric axis - Default', (WidgetTester tester) async {
      final _StepAreaNumeric chartContainer =
          _stepAreaNumeric('numeric_default') as _StepAreaNumeric;
    ...
    //   final _StepAreaNumeric chartContainer =
    //       _stepAreaNumeric('numeric_defaultData') as _StepAreaNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
  ...
  // group('StepArea Series - Range and Range Padding', () {
  //   testWidgets('Numeric axis - With Range', (WidgetTester tester) async {
  //     final _StepAreaNumeric chartContainer =
  //         _stepAreaNumeric('numeric_range') as _StepAreaNumeric;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  //     final _StepAreaNumeric chartContainer =
  //         _stepAreaNumeric('numeric_rangePadding_Add') as _StepAreaNumeric;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  //       (WidgetTester tester) async {
  //     final _StepAreaNumeric chartContainer =
  //         _stepAreaNumeric('numeric_rangePadding_Normal') as _StepAreaNumeric;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  //       (WidgetTester tester) async {
  //     final _StepAreaNumeric chartContainer =
  //         _stepAreaNumeric('numeric_rangePadding_Round') as _StepAreaNumeric;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  //       (WidgetTester tester) async {
  //     final _StepAreaNumeric chartContainer =
  //         _stepAreaNumeric('numeric_rangePadding_Auto') as _StepAreaNumeric;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  //       (WidgetTester tester) async {
  //     final _StepAreaNumeric chartContainer =
  //         _stepAreaNumeric('numeric_rangePadding_None') as _StepAreaNumeric;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  // group('StepArea Series - Numeric - Edge Label Placement', () {
  //   testWidgets('Numeric axis - EdgeLabelPlacement',
  //       (WidgetTester tester) async {
  //     final _StepAreaNumeric chartContainer =
  //         _stepAreaNumeric('numeric_edgelabelPlacement_hide')
  //             as _StepAreaNumeric;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  group('StepArea Series - Numeric - Axis Elements', () {
    // testWidgets('Numeric Axis - Visibility', (WidgetTester tester) async {
    //   final _StepAreaNumeric chartContainer =
    //       _stepAreaNumeric('numeric_axisVisible') as _StepAreaNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('Numeric Axis - Axis Line and Title',
        (WidgetTester tester) async {
      final _StepAreaNumeric chartContainer =
          _stepAreaNumeric('numeric_axisLine_title') as _StepAreaNumeric;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    //   final _StepAreaNumeric chartContainer =
    //       _stepAreaNumeric('numeric_inversed') as _StepAreaNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _StepAreaNumeric chartContainer =
    //       _stepAreaNumeric('numeric_opposed') as _StepAreaNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
  ...
  group('StepArea Series - Numeric - Major Grid and Line', () {
    testWidgets('Numeric Axis - Major Grid and Tick lines',
        (WidgetTester tester) async {
      final _StepAreaNumeric chartContainer =
          _stepAreaNumeric('numeric_gridlines') as _StepAreaNumeric;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    //   final _StepAreaNumeric chartContainer =
    //       _stepAreaNumeric('numeric_labelStyle') as _StepAreaNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
...
StatelessWidget _stepAreaNumeric(String sampleName) {
  return _StepAreaNumeric(sampleName);
}

// ignore: must_be_immutable
class _StepAreaNumeric extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _StepAreaNumeric(String sampleName) {
