...
/// Testing method of spline series data source.
void splineDataSource() {
...
// chart instance will get once pumpWidget is called
  ...
  group('Spline - DataSource', () {
    ...
    firstSegment.add(const Offset(34, 234.26666666666668));
    ...
    pointRegion.add(const Rect.fromLTRB(336.7, 192.8, 352.7, 208.84));
    ...
    testWidgets('Chart Widget - Testing Spline series Data Source',
      ...
      final _SplineDataSource chartContainer =
          _splineDataSource('spline_customization_pointColor')
              as _SplineDataSource;
    ...
    //           cartesianSeriesRenderer._segments[j] as SplineSegment;
...
//     final List<Offset> fourthSegmentGap = <Offset>[];
//     firstSegmentGap.add(const Offset(358.0, 132.4736842105263));
//     firstSegmentGap.add(const Offset(563.6521739130435, 26.4736842105263));
//     secondSegmentGap.add(const Offset(173.6521739130435, 343.4736842105263));
//     secondSegmentGap.add(const Offset(58.695652173913, 132.10526315789477));
//     thirdSegmentGap.add(const Offset(358.695652173913, 132.10526315789477));
//     thirdSegmentGap.add(const Offset(563.5652173913043, 26.421052631578974));
//     fourthSegmentGap.add(const Offset(563.5652173913043, 26.421052631578974));
//     fourthSegmentGap.add(const Offset(780.0, 26.421052631578974));
//     segmentGaps.add(firstSegmentGap);
//     segmentGaps.add(secondSegmentGap);
//     segmentGaps.add(thirdSegmentGap);
//     segmentGaps.add(fourthSegmentGap);
...
//     testWidgets(
//         'Chart Widget - Testing Spline series Data Source with empty point as gap',
//         (WidgetTester tester) async {
//       final _SplineDataSource chartContainer =
//           _splineDataSource('spline_dataSource_emptyPoint_gap')
//               as _SplineDataSource;
//       await tester.pumpWidget(chartContainer);
//       chart = chartContainer.chart;
...
// // Spline series with
//     testWidgets(
//         'Chart Widget - Testing Spline series Data Source with empty point as zero',
//         (WidgetTester tester) async {
//       final _SplineDataSource chartContainer =
//           _splineDataSource('spline_dataSource_emptyPoint_zero')
//               as _SplineDataSource;
//       await tester.pumpWidget(chartContainer);
//       chart = chartContainer.chart;
//       final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
...
//     fourthSegmentAvg.add(const Offset(780.0, 263.55));
...
//     testWidgets(
//         'Chart Widget - Testing Spline series Data Source with empty point as average',
//         (WidgetTester tester) async {
//       final _SplineDataSource chartContainer =
//           _splineDataSource('spline_dataSource_emptyPoint_avg')
//               as _SplineDataSource;
//       await tester.pumpWidget(chartContainer);
//       chart = chartContainer.chart;
//       final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
...
//     secondSegmentDrop.add(const Offset(563.56521739130435, 26.421052631578974));
...
//     testWidgets(
//         'Chart Widget - Testing Spline series Data Source with empty point as drop',
//         (WidgetTester tester) async {
//       final _SplineDataSource chartContainer =
//           _splineDataSource('spline_dataSource_emptyPoint_drop')
//               as _SplineDataSource;
//       await tester.pumpWidget(chartContainer);
//       chart = chartContainer.chart;
//       final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
...
//         (WidgetTester tester) async {
//       final _SplineDataSource chartContainer =
//           _splineDataSource('spline_dataSource_emptyPoint_null')
//               as _SplineDataSource;
//       await tester.pumpWidget(chartContainer);
//       chart = chartContainer.chart;
//       final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
...
StatelessWidget _splineDataSource(String sampleName) {
  return _SplineDataSource(sampleName);
}

// ignore: must_be_immutable
class _SplineDataSource extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _SplineDataSource(String sampleName) {
