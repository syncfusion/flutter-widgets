...
/// Test method of the spline series data label.
void splineDataLabel() {
  ...
  group('Spline - Data Label', () {
    testWidgets('Chart Widget - Testing Line Series with Data label',
        (WidgetTester tester) async {
      final _SplineDataLabel chartContainer =
          _splineDataLabel('dataLabel_default') as _SplineDataLabel;
    ...
    testWidgets(
        ...
        (WidgetTester tester) async {
      final _SplineDataLabel chartContainer =
          _splineDataLabel('dataLabel_customization') as _SplineDataLabel;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets(
        ...
        (WidgetTester tester) async {
      final _SplineDataLabel chartContainer =
          _splineDataLabel('dataLabel_mapping') as _SplineDataLabel;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
...
StatelessWidget _splineDataLabel(String sampleName) {
  return _SplineDataLabel(sampleName);
}

// ignore: must_be_immutable
class _SplineDataLabel extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _SplineDataLabel(String sampleName) {
