...
/// Testing method of range area series data source.
void rangeAreaDataSource() {
...
// chart instance will get once pumpWidget is called
  ...
  group('Range Area Series with DataSource', () {
    ...
    testWidgets('Chart Widget - Testing RangeArea series Data Source',
        (WidgetTester tester) async {
      final _RangeAreaDataSource chartContainer =
          _rangeAreaDataSource('customization_pointColor')
              as _RangeAreaDataSource;
  ...
  group('RangeArea Series - Empty points', () {
    ...
    pointRegionGap.add(const Rect.fromLTRB(145.5, 494.0, 161.5, 502.0));
    ...
    pointRegionGap.add(const Rect.fromLTRB(772.0, 494.0, 788.0, 502.0));

    testWidgets(
        'Chart Widget - Testing Line series Data Source with empty point as gap',
        (WidgetTester tester) async {
      final _RangeAreaDataSource chartContainer =
          _rangeAreaDataSource('dataSource_emptyPoint_gap')
              as _RangeAreaDataSource;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
...
// Line series with
    testWidgets(
        ...
        (WidgetTester tester) async {
      final _RangeAreaDataSource chartContainer =
          _rangeAreaDataSource('dataSource_emptyPoint_zero')
              as _RangeAreaDataSource;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets(
        'Chart Widget - Testing Range area series Data Source with empty point as average',
        (WidgetTester tester) async {
      final _RangeAreaDataSource chartContainer =
          _rangeAreaDataSource('dataSource_emptyPoint_avg')
              as _RangeAreaDataSource;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    pointRegionDrop.add(const Rect.fromLTRB(145.5, 494.0, 161.5, 502.0));
    ...
    pointRegionDrop.add(const Rect.fromLTRB(772.0, 494.0, 788.0, 502.0));

    testWidgets(
        'Chart Widget - Testing Line series Data Source with empty point as drop',
        (WidgetTester tester) async {
      final _RangeAreaDataSource chartContainer =
          _rangeAreaDataSource('dataSource_emptyPoint_drop')
              as _RangeAreaDataSource;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    pointRegionNull.add(const Rect.fromLTRB(26.0, 494.0, 42.0, 502.0));
    pointRegionNull.add(const Rect.fromLTRB(145.5, 494.0, 161.5, 502.0));
    pointRegionNull.add(const Rect.fromLTRB(336.7, 494.0, 352.7, 502.0));
    pointRegionNull.add(const Rect.fromLTRB(548.4, 494.0, 564.4, 502.0));
    pointRegionNull.add(const Rect.fromLTRB(772.0, 494.0, 788.0, 502.0));

    testWidgets(
        'Chart Widget - Testing Line series Data Source with empty point as average',
        (WidgetTester tester) async {
      final _RangeAreaDataSource chartContainer =
          _rangeAreaDataSource('dataSource_emptyPoint_null')
              as _RangeAreaDataSource;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
...
StatelessWidget _rangeAreaDataSource(String sampleName) {
  return _RangeAreaDataSource(sampleName);
}

// ignore: must_be_immutable
class _RangeAreaDataSource extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _RangeAreaDataSource(String sampleName) {
