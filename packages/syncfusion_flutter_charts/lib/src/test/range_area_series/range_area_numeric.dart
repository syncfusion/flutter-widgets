...
/// Test method for numeric axis of the range area series.
void rangeAreaNumericAxis() {
  ...
  group('RangeArea Series - Numeric Axis Default properties', () {
    testWidgets('Numeric axis - Default', (WidgetTester tester) async {
      final _RangeAreaNumeric chartContainer =
          _rangeAreaNumeric('numeric_default') as _RangeAreaNumeric;
    ...
    testWidgets('Numeric axis - With Data', (WidgetTester tester) async {
      final _RangeAreaNumeric chartContainer =
          _rangeAreaNumeric('numeric_defaultData') as _RangeAreaNumeric;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
  ...
  // group('Range Area Series - Range and Range Padding', () {
  //   testWidgets('Numeric axis - With Range', (WidgetTester tester) async {
  //     final _RangeAreaNumeric chartContainer =
  //         _rangeAreaNumeric('numeric_range') as _RangeAreaNumeric;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  ...
  //     final _RangeAreaNumeric chartContainer =
  //         _rangeAreaNumeric('numeric_rangePadding_Add') as _RangeAreaNumeric;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  //       (WidgetTester tester) async {
  //     final _RangeAreaNumeric chartContainer =
  //         _rangeAreaNumeric('numeric_rangePadding_Normal') as _RangeAreaNumeric;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  //       (WidgetTester tester) async {
  //     final _RangeAreaNumeric chartContainer =
  //         _rangeAreaNumeric('numeric_rangePadding_Round') as _RangeAreaNumeric;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  //       (WidgetTester tester) async {
  //     final _RangeAreaNumeric chartContainer =
  //         _rangeAreaNumeric('numeric_rangePadding_Auto') as _RangeAreaNumeric;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  //       (WidgetTester tester) async {
  //     final _RangeAreaNumeric chartContainer =
  //         _rangeAreaNumeric('numeric_rangePadding_None') as _RangeAreaNumeric;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  //       (WidgetTester tester) async {
  //     final _RangeAreaNumeric chartContainer =
  //         _rangeAreaNumeric('numeric_edgelabelPlacement_hide')
  //             as _RangeAreaNumeric;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  group('Range Area Series - Numeric - Axis Elements', () {
    ...
    //   final _RangeAreaNumeric chartContainer =
    //       _rangeAreaNumeric('numeric_axisVisible') as _RangeAreaNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('Numeric Axis - Axis Line and Title',
        (WidgetTester tester) async {
      final _RangeAreaNumeric chartContainer =
          _rangeAreaNumeric('numeric_axisLine_title') as _RangeAreaNumeric;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    //   final _RangeAreaNumeric chartContainer =
    //       _rangeAreaNumeric('numeric_inversed') as _RangeAreaNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _RangeAreaNumeric chartContainer =
    //       _rangeAreaNumeric('numeric_opposed') as _RangeAreaNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
  ...
  group('Range Area Series - Numeric - Major Grid and Line', () {
    testWidgets('Numeric Axis - Major Grid and Tick lines',
        (WidgetTester tester) async {
      final _RangeAreaNumeric chartContainer =
          _rangeAreaNumeric('numeric_gridlines') as _RangeAreaNumeric;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('Numeric Axis - Label Style', (WidgetTester tester) async {
      final _RangeAreaNumeric chartContainer =
          _rangeAreaNumeric('numeric_labelStyle') as _RangeAreaNumeric;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
...
StatelessWidget _rangeAreaNumeric(String sampleName) {
  return _RangeAreaNumeric(sampleName);
}

// ignore: must_be_immutable
class _RangeAreaNumeric extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _RangeAreaNumeric(String sampleName) {
