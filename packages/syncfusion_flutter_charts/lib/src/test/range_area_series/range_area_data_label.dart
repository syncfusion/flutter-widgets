...
/// Test method of the range area series data label.
void rangeAreaDataLabel() {
  ...
  group('RangeArea Data label', () {
    testWidgets('Chart Widget - Testing RangeArea Series with Data label',
      ...
      final _RangeAreaDataLabel chartContainer =
          _rangeAreaDataLabel('dataLabel_default') as _RangeAreaDataLabel;
    ...
    testWidgets(
        ...
        (WidgetTester tester) async {
      final _RangeAreaDataLabel chartContainer =
          _rangeAreaDataLabel('dataLabel_customization') as _RangeAreaDataLabel;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets(
        ...
        (WidgetTester tester) async {
      final _RangeAreaDataLabel chartContainer =
          _rangeAreaDataLabel('dataLabel_mapping') as _RangeAreaDataLabel;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
...
StatelessWidget _rangeAreaDataLabel(String sampleName) {
  return _RangeAreaDataLabel(sampleName);
}

// ignore: must_be_immutable
class _RangeAreaDataLabel extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _RangeAreaDataLabel(String sampleName) {
