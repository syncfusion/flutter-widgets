...
/// Test method for numeric axis of the scatter series.
void scatterNumericAxis() {
  ...
  group('Scatter Numeric - Range and Range Padding', () {
    testWidgets('Numeric axis - Default', (WidgetTester tester) async {
      final _ScatterNumeric chartContainer =
          _scatterNumeric('numeric_default') as _ScatterNumeric;
    ...
    //   final _ScatterNumeric chartContainer =
    //       _scatterNumeric('numeric_defaultData') as _ScatterNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _ScatterNumeric chartContainer =
    //       _scatterNumeric('numeric_range') as _ScatterNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _ScatterNumeric chartContainer =
    //       _scatterNumeric('numeric_rangePadding_Add') as _ScatterNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //     (WidgetTester tester) async {
    //   final _ScatterNumeric chartContainer =
    //       _scatterNumeric('numeric_rangePadding_Normal') as _ScatterNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //     (WidgetTester tester) async {
    //   final _ScatterNumeric chartContainer =
    //       _scatterNumeric('numeric_rangePadding_Round') as _ScatterNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //     (WidgetTester tester) async {
    //   final _ScatterNumeric chartContainer =
    //       _scatterNumeric('numeric_rangePadding_Auto') as _ScatterNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //     (WidgetTester tester) async {
    //   final _ScatterNumeric chartContainer =
    //       _scatterNumeric('numeric_rangePadding_None') as _ScatterNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
  ...
  group('Scatter Numeric- EdgeLabelPlacement, Inversed, Opposed', () {
    // testWidgets('Numeric axis - EdgeLabelPlacement',
    //     (WidgetTester tester) async {
    //   final _ScatterNumeric chartContainer =
    //       _scatterNumeric('numeric_edgelabelPlacement_hide') as _ScatterNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _ScatterNumeric chartContainer =
    //       _scatterNumeric('numeric_inversed') as _ScatterNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _ScatterNumeric chartContainer =
    //       _scatterNumeric('numeric_opposed') as _ScatterNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
  ...
  group('Scatter Numeric- Grids, Ticks, Axis Elements', () {
    testWidgets('Numeric Axis - Axis Line and Title',
        (WidgetTester tester) async {
      final _ScatterNumeric chartContainer =
          _scatterNumeric('numeric_axisLine_title') as _ScatterNumeric;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('Numeric Axis - Major Grid and Tick lines',
        (WidgetTester tester) async {
      final _ScatterNumeric chartContainer =
          _scatterNumeric('numeric_gridlines') as _ScatterNumeric;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('Numeric Axis - Label Style', (WidgetTester tester) async {
      final _ScatterNumeric chartContainer =
          _scatterNumeric('numeric_labelStyle') as _ScatterNumeric;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _ScatterNumeric chartContainer =
    //       _scatterNumeric('numeric_axisVisible') as _ScatterNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
...
StatelessWidget _scatterNumeric(String sampleName) {
  return _ScatterNumeric(sampleName);
}

// ignore: must_be_immutable
class _ScatterNumeric extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _ScatterNumeric(String sampleName) {
