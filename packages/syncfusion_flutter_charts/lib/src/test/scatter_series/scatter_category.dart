...
/// Test method of category axis of the scatter series.
void scatterCategoryAxis() {
  ...
  group('Scatter Category - Defualt Properties', () {
    testWidgets('Category axis - Default', (WidgetTester tester) async {
      final _ScatterCategory chartContainer =
          _scatterCategory('category_default') as _ScatterCategory;
...
//  group('Scatter Cateogry - Label Placcement and EdgelabelPlacement', () {
  // //Category Axis
  // testWidgets('Category axis - LabelPlacement', (WidgetTester tester) async {
  //   final _ScatterCategory chartContainer =
  //       _scatterCategory('category_labelPlacement') as _ScatterCategory;
  //   await tester.pumpWidget(chartContainer);
  //   chart = chartContainer.chart;
  //   // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //   // _chartState = key.currentState as SfCartesianChartState?;
  ...
  //     final _ScatterCategory chartContainer =
  //         _scatterCategory('category_EdgeLabelPlacement') as _ScatterCategory;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  // group('Scatter - Inversed, Opposed', () {
  //   //Category Axis
  //   testWidgets('Category axis - Inversed', (WidgetTester tester) async {
  //     final _ScatterCategory chartContainer =
  //         _scatterCategory('category_inversed') as _ScatterCategory;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     // _chartState = key.currentState as SfCartesianChartState?;
  ...
  //     final _ScatterCategory chartContainer =
  //         _scatterCategory('category_opposed') as _ScatterCategory;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  //         cartesianSeriesRenderer._segments[0] as ScatterSegment;
  //     expect(segment.points[0].dx.toInt(), 74);
  //     expect(segment.points[0].dy.toInt(), 256);
  //     expect(
  //         _chartState!._chartAxis._primaryXAxisRenderer._visibleLabels[0].text,
  //         'India');
  //     expect(
  ...
  group('Scatter Category - Grids, Ticks, Axis Elements', () {
    //Category Axis
    testWidgets('Category Axis - Label and Tick Position',
        (WidgetTester tester) async {
      final _ScatterCategory chartContainer =
          _scatterCategory('category_label_tickPosition') as _ScatterCategory;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('Category Axis - Major Grid and Tick lines',
        (WidgetTester tester) async {
      final _ScatterCategory chartContainer =
          _scatterCategory('category_gridlines') as _ScatterCategory;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _ScatterCategory chartContainer =
    //       _scatterCategory('category_labelStyle') as _ScatterCategory;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   // _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _ScatterCategory chartContainer =
    //       _scatterCategory('category_axisVisible') as _ScatterCategory;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('Category Axis - Axis Line', (WidgetTester tester) async {
      final _ScatterCategory chartContainer =
          _scatterCategory('category_axisLine_title') as _ScatterCategory;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
...
StatelessWidget _scatterCategory(String sampleName) {
  return _ScatterCategory(sampleName);
}

// ignore: must_be_immutable
class _ScatterCategory extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _ScatterCategory(String sampleName) {
