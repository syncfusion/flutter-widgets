...
/// Test method of category axis of the stacked line series.
void stackedLineCategoryAxis() {
  ...
  group('Stacked Line Category - Defualt Properties', () {
    testWidgets('Category axis - Default', (WidgetTester tester) async {
      final _StackedLineCategory chartContainer =
          _stackedLineCategory('category_default') as _StackedLineCategory;
...
// to test series count
    ...
    testWidgets('Category axis - LabelPlacement', (WidgetTester tester) async {
      final _StackedLineCategory chartContainer =
          _stackedLineCategory('category_labelPlacement')
              as _StackedLineCategory;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
  ...
  group('Bar Category - Axis Elements', () {
    ...
    //   final _StackedLineCategory chartContainer =
    //       _stackedLineCategory('category_EdgeLabelPlacement')
    //           as _StackedLineCategory;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    ...
    //   final _StackedLineCategory chartContainer =
    //       _stackedLineCategory('category_inversed') as _StackedLineCategory;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _StackedLineCategory chartContainer =
    //       _stackedLineCategory('category_opposed') as _StackedLineCategory;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('Category Axis - Label and Tick Position',
        (WidgetTester tester) async {
      final _StackedLineCategory chartContainer =
          _stackedLineCategory('category_label_tickPosition')
              as _StackedLineCategory;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('Category Axis - Major Grid and Tick lines',
        (WidgetTester tester) async {
      final _StackedLineCategory chartContainer =
          _stackedLineCategory('category_gridlines') as _StackedLineCategory;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    //   final _StackedLineCategory chartContainer =
    //       _stackedLineCategory('category_labelStyle') as _StackedLineCategory;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('Category Axis - Visibility', (WidgetTester tester) async {
      final _StackedLineCategory chartContainer =
          _stackedLineCategory('category_axisVisible') as _StackedLineCategory;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('Category Axis - Axis Line', (WidgetTester tester) async {
      final _StackedLineCategory chartContainer =
          _stackedLineCategory('category_axisLine_title')
              as _StackedLineCategory;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
...
StatelessWidget _stackedLineCategory(String sampleName) {
  return _StackedLineCategory(sampleName);
}

// ignore: must_be_immutable
class _StackedLineCategory extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _StackedLineCategory(String sampleName) {
