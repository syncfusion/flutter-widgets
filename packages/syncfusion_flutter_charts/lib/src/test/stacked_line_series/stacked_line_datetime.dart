...
/// Test method for date time axis of the stacked line series.
void stackedLineDateTimeAxis() {
  ...
  group('Column Date Time - Range and Range Padding', () {
    testWidgets('DateTime axis - Default', (WidgetTester tester) async {
      final _StackedLineDateTime chartContainer =
          _stackedLineDateTime('datetime_default') as _StackedLineDateTime;
    ...
    //   final _StackedLineDateTime chartContainer =
    //       _stackedLineDateTime('datetime_range') as _StackedLineDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    ...
    //   final _StackedLineDateTime chartContainer =
    //       _stackedLineDateTime('datetime_rangepadding_add')
    //           as _StackedLineDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
  ...
  //     (WidgetTester tester) async {
  //   final _StackedLineDateTime chartContainer =
  //       _stackedLineDateTime('datetime_rangepadding_normal')
  //           as _StackedLineDateTime;
  //   await tester.pumpWidget(chartContainer);
  //   chart = chartContainer.chart;
  //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  //     (WidgetTester tester) async {
  //   final _StackedLineDateTime chartContainer =
  //       _stackedLineDateTime('datetime_rangepadding_round')
  //           as _StackedLineDateTime;
  //   await tester.pumpWidget(chartContainer);
  //   chart = chartContainer.chart;
  //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  //     (WidgetTester tester) async {
  //   final _StackedLineDateTime chartContainer =
  //       _stackedLineDateTime('datetime_rangepadding_none')
  //           as _StackedLineDateTime;
  //   await tester.pumpWidget(chartContainer);
  //   chart = chartContainer.chart;
  //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  //     (WidgetTester tester) async {
  //   final _StackedLineDateTime chartContainer =
  //       _stackedLineDateTime('datetime_rangepadding_auto')
  //           as _StackedLineDateTime;
  //   await tester.pumpWidget(chartContainer);
  //   chart = chartContainer.chart;
  //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  group('Column Date Time - Grids, Ticks and Axis Elements', () {
    // testWidgets('DateTime axis - EdgeLabelPlacement',
    //     (WidgetTester tester) async {
    //   final _StackedLineDateTime chartContainer =
    //       _stackedLineDateTime('datetime_edgelabelPlacement_hide')
    //           as _StackedLineDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    testWidgets('DateTime Axis - Axis Line and Title',
        (WidgetTester tester) async {
      final _StackedLineDateTime chartContainer =
          _stackedLineDateTime('datetime_axisLine_title')
              as _StackedLineDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    //   final _StackedLineDateTime chartContainer =
    //       _stackedLineDateTime('datetime_inversed') as _StackedLineDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _StackedLineDateTime chartContainer =
    //       _stackedLineDateTime('datetime_opposed') as _StackedLineDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('DateTime Axis - Major Grid and Tick lines',
        (WidgetTester tester) async {
      final _StackedLineDateTime chartContainer =
          _stackedLineDateTime('datetime_gridlines') as _StackedLineDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    //   final _StackedLineDateTime chartContainer =
    //       _stackedLineDateTime('datetime_labelStyle') as _StackedLineDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _StackedLineDateTime chartContainer =
    //       _stackedLineDateTime('datetime_axisVisible') as _StackedLineDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
...
StatelessWidget _stackedLineDateTime(String sampleName) {
  return _StackedLineDateTime(sampleName);
}

// ignore: must_be_immutable
class _StackedLineDateTime extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _StackedLineDateTime(String sampleName) {
