...
/// Test method of category axis of the stacked bar 100 series.
void stackedBar100CategoryAxis() {
  ...
  group('Stacked Bar Category - Defualt Properties', () {
    testWidgets('Category axis - Default', (WidgetTester tester) async {
      final _StackedBar100Category chartContainer =
          _stackedBar100Category('category_default') as _StackedBar100Category;
...
// to test series count
    ...
    //   final _StackedBar100Category chartContainer =
    //       _stackedBar100Category('category_labelPlacement')
    //           as _StackedBar100Category;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
  ...
  group('Stacked Bar Category - Axis Elements', () {
    ...
    //   final _StackedBar100Category chartContainer =
    //       _stackedBar100Category('category_EdgeLabelPlacement')
    //           as _StackedBar100Category;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    //   final _StackedBar100Category chartContainer =
    //       _stackedBar100Category('category_inversed') as _StackedBar100Category;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _StackedBar100Category chartContainer =
    //       _stackedBar100Category('category_opposed') as _StackedBar100Category;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('Category Axis - Label and Tick Position',
        (WidgetTester tester) async {
      final _StackedBar100Category chartContainer =
          _stackedBar100Category('category_label_tickPosition')
              as _StackedBar100Category;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('Category Axis - Major Grid and Tick lines',
        (WidgetTester tester) async {
      final _StackedBar100Category chartContainer =
          _stackedBar100Category('category_gridlines')
              as _StackedBar100Category;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    //   final _StackedBar100Category chartContainer =
    //       _stackedBar100Category('category_labelStyle')
    //           as _StackedBar100Category;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    testWidgets('Category Axis - Visibility', (WidgetTester tester) async {
      final _StackedBar100Category chartContainer =
          _stackedBar100Category('category_axisVisible')
              as _StackedBar100Category;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('Category Axis - Axis Line', (WidgetTester tester) async {
      final _StackedBar100Category chartContainer =
          _stackedBar100Category('category_axisLine_title')
              as _StackedBar100Category;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
...
StatelessWidget _stackedBar100Category(String sampleName) {
  return _StackedBar100Category(sampleName);
}

// ignore: must_be_immutable
class _StackedBar100Category extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _StackedBar100Category(String sampleName) {
