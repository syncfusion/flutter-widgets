...
/// Test method for date time axis of the stacked bar 100 series.
void stackedBar100DateTimeAxis() {
  // Define a test. The TestWidgets function will also provide a WidgetTester
  // for us to work with. The
  //WidgetTester will allow us to build and interact
  ...
  group('Bar Date Time - Range and Range Padding', () {
    testWidgets('DateTime axis - Default', (WidgetTester tester) async {
      final _StackedBar100DateTime chartContainer =
          _stackedBar100DateTime('datetime_default') as _StackedBar100DateTime;
    ...
    //   final _StackedBar100DateTime chartContainer =
    //       _stackedBar100DateTime('datetime_range') as _StackedBar100DateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    ...
    //   final _StackedBar100DateTime chartContainer =
    //       _stackedBar100DateTime('datetime_rangepadding_add')
    //           as _StackedBar100DateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //     (WidgetTester tester) async {
    //   final _StackedBar100DateTime chartContainer =
    //       _stackedBar100DateTime('datetime_rangepadding_normal')
    //           as _StackedBar100DateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    //     (WidgetTester tester) async {
    //   final _StackedBar100DateTime chartContainer =
    //       _stackedBar100DateTime('datetime_rangepadding_round')
    //           as _StackedBar100DateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    //     (WidgetTester tester) async {
    //   final _StackedBar100DateTime chartContainer =
    //       _stackedBar100DateTime('datetime_rangepadding_none')
    //           as _StackedBar100DateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    //     (WidgetTester tester) async {
    //   final _StackedBar100DateTime chartContainer =
    //       _stackedBar100DateTime('datetime_rangepadding_auto')
    //           as _StackedBar100DateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  //       (WidgetTester tester) async {
  //     final _StackedBar100DateTime chartContainer =
  //         _stackedBar100DateTime('datetime_edgelabelPlacement_hide')
  //             as _StackedBar100DateTime;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  group('Bar Date Time - Grids, Ticks and Axis Elements', () {
    testWidgets('DateTime Axis - Axis Line and Title',
        (WidgetTester tester) async {
      final _StackedBar100DateTime chartContainer =
          _stackedBar100DateTime('datetime_axisLine_title')
              as _StackedBar100DateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    //   final _StackedBar100DateTime chartContainer =
    //       _stackedBar100DateTime('datetime_inversed') as _StackedBar100DateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _StackedBar100DateTime chartContainer =
    //       _stackedBar100DateTime('datetime_opposed') as _StackedBar100DateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('DateTime Axis - Major Grid and Tick lines',
        (WidgetTester tester) async {
      final _StackedBar100DateTime chartContainer =
          _stackedBar100DateTime('datetime_gridlines')
              as _StackedBar100DateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('DateTime Axis - Label Style', (WidgetTester tester) async {
      final _StackedBar100DateTime chartContainer =
          _stackedBar100DateTime('datetime_labelStyle')
              as _StackedBar100DateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    //   final _StackedBar100DateTime chartContainer =
    //       _stackedBar100DateTime('datetime_axisVisible')
    //           as _StackedBar100DateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
...
StatelessWidget _stackedBar100DateTime(String sampleName) {
  return _StackedBar100DateTime(sampleName);
}

// ignore: must_be_immutable
class _StackedBar100DateTime extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _StackedBar100DateTime(String sampleName) {
