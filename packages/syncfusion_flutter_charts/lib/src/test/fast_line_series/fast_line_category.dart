...
/// Test method of category axis of the fast line series.
void fastLineCategoryAxis() {
  ...
  // group('Fast Line Category - Default Properties', () {
  //   testWidgets('Category axis - Default', (WidgetTester tester) async {
  //     final _FastLineCategory chartContainer =
  //         _fastLineCategory('category_default') as _FastLineCategory;
  ...
  group('Fast Line Category - Grids, Ticks and Axis Elements', () {
    //Category Axis
    testWidgets('Category axis - LabelPlacement', (WidgetTester tester) async {
      final _FastLineCategory chartContainer =
          _fastLineCategory('category_labelPlacement') as _FastLineCategory;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _FastLineCategory chartContainer =
    //       _fastLineCategory('category_EdgeLabelPlacement') as _FastLineCategory;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _FastLineCategory chartContainer =
    //       _fastLineCategory('category_inversed') as _FastLineCategory;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _FastLineCategory chartContainer =
    //       _fastLineCategory('category_opposed') as _FastLineCategory;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('Category Axis - Label and Tick Position',
        (WidgetTester tester) async {
      final _FastLineCategory chartContainer =
          _fastLineCategory('category_label_tickPosition') as _FastLineCategory;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('Category Axis - Major Grid and Tick lines',
        (WidgetTester tester) async {
      final _FastLineCategory chartContainer =
          _fastLineCategory('category_gridlines') as _FastLineCategory;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('Category Axis - Label Style', (WidgetTester tester) async {
      final _FastLineCategory chartContainer =
          _fastLineCategory('category_labelStyle') as _FastLineCategory;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _FastLineCategory chartContainer =
    //       _fastLineCategory('category_axisVisible') as _FastLineCategory;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('Category Axis - Axis Line', (WidgetTester tester) async {
      final _FastLineCategory chartContainer =
          _fastLineCategory('category_axisLine_title') as _FastLineCategory;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
...
StatelessWidget _fastLineCategory(String sampleName) {
  return _FastLineCategory(sampleName);
}

// ignore: must_be_immutable
class _FastLineCategory extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _FastLineCategory(String sampleName) {
