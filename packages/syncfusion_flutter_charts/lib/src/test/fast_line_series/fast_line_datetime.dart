...
/// Test method for date time axis of the fast line series.
void fastLineDateTimeAxis() {
  ...
  group('Fast Line Date Time - Range', () {
    testWidgets('DateTime axis - Default', (WidgetTester tester) async {
      final _FastLineDateTime chartContainer =
          _fastLineDateTime('datetime_default') as _FastLineDateTime;
    ...
    testWidgets('Datetime axis - With Range', (WidgetTester tester) async {
      final _FastLineDateTime chartContainer =
          _fastLineDateTime('datetime_range') as _FastLineDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _FastLineDateTime chartContainer =
    //       _fastLineDateTime('datetime_rangepadding_add') as _FastLineDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   // _chartState = key.currentState as SfCartesianChartState?;
    ...
    //     (WidgetTester tester) async {
    //   final _FastLineDateTime chartContainer =
    //       _fastLineDateTime('datetime_rangepadding_normal')
    //           as _FastLineDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //     (WidgetTester tester) async {
    //   final _FastLineDateTime chartContainer =
    //       _fastLineDateTime('datetime_rangepadding_round') as _FastLineDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //     (WidgetTester tester) async {
    //   final _FastLineDateTime chartContainer =
    //       _fastLineDateTime('datetime_rangepadding_none') as _FastLineDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //     (WidgetTester tester) async {
    //   final _FastLineDateTime chartContainer =
    //       _fastLineDateTime('datetime_rangepadding_auto') as _FastLineDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
  ...
  group('Fast Line Date Time - Grids, Ticks and Axis Elements', () {
    // testWidgets('DateTime axis - EdgeLabelPlacement',
    //     (WidgetTester tester) async {
    //   final _FastLineDateTime chartContainer =
    //       _fastLineDateTime('datetime_edgelabelPlacement_hide')
    //           as _FastLineDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    testWidgets('DateTime Axis - Axis Line and Title',
        (WidgetTester tester) async {
      final _FastLineDateTime chartContainer =
          _fastLineDateTime('datetime_axisLine_title') as _FastLineDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _FastLineDateTime chartContainer =
    //       _fastLineDateTime('datetime_inversed') as _FastLineDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _FastLineDateTime chartContainer =
    //       _fastLineDateTime('datetime_opposed') as _FastLineDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('DateTime Axis - Major Grid and Tick lines',
        (WidgetTester tester) async {
      final _FastLineDateTime chartContainer =
          _fastLineDateTime('datetime_gridlines') as _FastLineDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('DateTime Axis - Label Style', (WidgetTester tester) async {
      final _FastLineDateTime chartContainer =
          _fastLineDateTime('datetime_labelStyle') as _FastLineDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _FastLineDateTime chartContainer =
    //       _fastLineDateTime('datetime_axisVisible') as _FastLineDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
...
StatelessWidget _fastLineDateTime(String sampleName) {
  return _FastLineDateTime(sampleName);
}

// ignore: must_be_immutable
class _FastLineDateTime extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _FastLineDateTime(String sampleName) {
