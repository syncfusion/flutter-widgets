...
/// Test method for numeric axis of the step line series.
void stepLineNumericAxis() {
  ...
  group('Step Line Numeric - Range and Range Padding', () {
    testWidgets('Numeric axis - Default', (WidgetTester tester) async {
      final _StepLineNumeric chartContainer =
          _stepLineNumeric('numeric_default') as _StepLineNumeric;
    ...
    // // StepLine series with data
    // testWidgets('Numeric axis - With Data', (WidgetTester tester) async {
    //   final _StepLineNumeric chartContainer =
    //       _stepLineNumeric('numeric_defaultData') as _StepLineNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    ...
    //   final _StepLineNumeric chartContainer =
    //       _stepLineNumeric('numeric_range') as _StepLineNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _StepLineNumeric chartContainer =
    //       _stepLineNumeric('numeric_rangePadding_Add') as _StepLineNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //     (WidgetTester tester) async {
    //   final _StepLineNumeric chartContainer =
    //       _stepLineNumeric('numeric_rangePadding_Normal') as _StepLineNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //     (WidgetTester tester) async {
    //   final _StepLineNumeric chartContainer =
    //       _stepLineNumeric('numeric_rangePadding_Round') as _StepLineNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //     (WidgetTester tester) async {
    //   final _StepLineNumeric chartContainer =
    //       _stepLineNumeric('numeric_rangePadding_Auto') as _StepLineNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //     (WidgetTester tester) async {
    //   final _StepLineNumeric chartContainer =
    //       _stepLineNumeric('numeric_rangePadding_None') as _StepLineNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
  ...
  // group('Step Line Numeric - EdgeLabelPlacement, Inversed, Opposed', () {
  //   testWidgets('Numeric axis - EdgeLabelPlacement',
  //       (WidgetTester tester) async {
  //     final _StepLineNumeric chartContainer =
  //         _stepLineNumeric('numeric_edgelabelPlacement_hide')
  //             as _StepLineNumeric;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  //     final _StepLineNumeric chartContainer =
  //         _stepLineNumeric('numeric_inversed') as _StepLineNumeric;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  //     final _StepLineNumeric chartContainer =
  //         _stepLineNumeric('numeric_opposed') as _StepLineNumeric;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  group('Step Line Numeric - Grids, Ticks, Axis Elements', () {
    testWidgets('Numeric Axis - Axis Line and Title',
        (WidgetTester tester) async {
      final _StepLineNumeric chartContainer =
          _stepLineNumeric('numeric_axisLine_title') as _StepLineNumeric;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('Numeric Axis - Major Grid and Tick lines',
        (WidgetTester tester) async {
      final _StepLineNumeric chartContainer =
          _stepLineNumeric('numeric_gridlines') as _StepLineNumeric;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('Numeric Axis - Label Style', (WidgetTester tester) async {
      final _StepLineNumeric chartContainer =
          _stepLineNumeric('numeric_labelStyle') as _StepLineNumeric;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    //   final _StepLineNumeric chartContainer =
    //       _stepLineNumeric('numeric_axisVisible') as _StepLineNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
...
StatelessWidget _stepLineNumeric(String sampleName) {
  return _StepLineNumeric(sampleName);
}

// ignore: must_be_immutable
class _StepLineNumeric extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _StepLineNumeric(String sampleName) {
