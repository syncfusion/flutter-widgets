...
/// Test method of the step line series data label.
void stepLineDataLabel() {
  ...
  group('Step Line - Data Label', () {
    testWidgets('Chart Widget - Testing Line Series with Data label',
        (WidgetTester tester) async {
      final _StepLineDataLabel chartContainer =
          _stepLineDataLabel('dataLabel_default') as _StepLineDataLabel;
    ...
    testWidgets(
        ...
        (WidgetTester tester) async {
      final _StepLineDataLabel chartContainer =
          _stepLineDataLabel('dataLabel_customization') as _StepLineDataLabel;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets(
        ...
        (WidgetTester tester) async {
      final _StepLineDataLabel chartContainer =
          _stepLineDataLabel('dataLabel_mapping') as _StepLineDataLabel;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
...
StatelessWidget _stepLineDataLabel(String sampleName) {
  return _StepLineDataLabel(sampleName);
}

// ignore: must_be_immutable
class _StepLineDataLabel extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _StepLineDataLabel(String sampleName) {
