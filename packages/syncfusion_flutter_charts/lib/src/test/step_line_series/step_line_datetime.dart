...
/// Test method for date time axis of the step line series.
void stepLineDateTimeAxis() {
  ...
  group('Step Line  Date Time - Range and Raneg Padding', () {
    testWidgets('DateTime axis - Default', (WidgetTester tester) async {
      final _StepLineDateTime chartContainer =
          _stepLineDateTime('datetime_default') as _StepLineDateTime;
    ...
    //   final _StepLineDateTime chartContainer =
    //       _stepLineDateTime('datetime_range') as _StepLineDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    ...
    //   final _StepLineDateTime chartContainer =
    //       _stepLineDateTime('datetime_rangepadding_add') as _StepLineDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //     (WidgetTester tester) async {
    //   final _StepLineDateTime chartContainer =
    //       _stepLineDateTime('datetime_rangepadding_normal')
    //           as _StepLineDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //     (WidgetTester tester) async {
    //   final _StepLineDateTime chartContainer =
    //       _stepLineDateTime('datetime_rangepadding_round') as _StepLineDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //     (WidgetTester tester) async {
    //   final _StepLineDateTime chartContainer =
    //       _stepLineDateTime('datetime_rangepadding_none') as _StepLineDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //     (WidgetTester tester) async {
    //   final _StepLineDateTime chartContainer =
    //       _stepLineDateTime('datetime_rangepadding_auto') as _StepLineDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
  ...
  // group('Step Line Date Time - EdgeLabelPlacement, Inversed, Opposed', () {
  //   testWidgets('DateTime axis - EdgeLabelPlacement',
  //       (WidgetTester tester) async {
  //     final _StepLineDateTime chartContainer =
  //         _stepLineDateTime('datetime_edgelabelPlacement_hide')
  //             as _StepLineDateTime;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  //     final _StepLineDateTime chartContainer =
  //         _stepLineDateTime('datetime_inversed') as _StepLineDateTime;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  //     final _StepLineDateTime chartContainer =
  //         _stepLineDateTime('datetime_opposed') as _StepLineDateTime;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  group('Step Line Date Time - Grids, Ticks, Axis Elements', () {
    testWidgets('DateTime Axis - Axis Line and Title',
        (WidgetTester tester) async {
      final _StepLineDateTime chartContainer =
          _stepLineDateTime('datetime_axisLine_title') as _StepLineDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('DateTime Axis - Major Grid and Tick lines',
        (WidgetTester tester) async {
      final _StepLineDateTime chartContainer =
          _stepLineDateTime('datetime_gridlines') as _StepLineDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    //   final _StepLineDateTime chartContainer =
    //       _stepLineDateTime('datetime_labelStyle') as _StepLineDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _StepLineDateTime chartContainer =
    //       _stepLineDateTime('datetime_axisVisible') as _StepLineDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
...
StatelessWidget _stepLineDateTime(String sampleName) {
  return _StepLineDateTime(sampleName);
}

// ignore: must_be_immutable
class _StepLineDateTime extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _StepLineDateTime(String sampleName) {
