...
/// Test method of the line series data label.
void lineDataLabel() {
  ...
  group('Line - Data Label', () {
    testWidgets('Chart Widget - Testing Line Series with Data label',
        (WidgetTester tester) async {
      final _LineDateLabel chartContainer =
          _lineDateLabel('dataLabel_default') as _LineDateLabel;
    ...
    testWidgets(
        ...
        (WidgetTester tester) async {
      final _LineDateLabel chartContainer =
          _lineDateLabel('dataLabel_customization') as _LineDateLabel;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets(
        ...
        (WidgetTester tester) async {
      final _LineDateLabel chartContainer =
          _lineDateLabel('dataLabel_mapping') as _LineDateLabel;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
...
StatelessWidget _lineDateLabel(String sampleName) {
  return _LineDateLabel(sampleName);
}

// ignore: must_be_immutable
class _LineDateLabel extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _LineDateLabel(String sampleName) {
