...
/// Test method for date time axis of the line series.
void lineDateTimeAxis() {
  ...
  group('Line Date Time - Range and Range Padding', () {
    testWidgets('DateTime axis - Default', (WidgetTester tester) async {
      final _LineDateTime chartContainer =
          _lineDateTime('datetime_default') as _LineDateTime;
    ...
    //   final _LineDateTime chartContainer =
    //       _lineDateTime('datetime_range') as _LineDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   // _chartState = key.currentState as SfCartesianChartState?;
    ...
    //     final _LineDateTime chartContainer =
    //         _lineDateTime('datetime_rangepadding_add') as _LineDateTime;
    //     await tester.pumpWidget(chartContainer);
    //     chart = chartContainer.chart;
    //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //     _chartState = key.currentState as SfCartesianChartState?;
    ...
    //       (WidgetTester tester) async {
    //     final _LineDateTime chartContainer =
    //         _lineDateTime('datetime_rangepadding_normal') as _LineDateTime;
    //     await tester.pumpWidget(chartContainer);
    //     chart = chartContainer.chart;
    //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //     _chartState = key.currentState as SfCartesianChartState?;
    ...
    //       (WidgetTester tester) async {
    //     final _LineDateTime chartContainer =
    //         _lineDateTime('datetime_rangepadding_round') as _LineDateTime;
    //     await tester.pumpWidget(chartContainer);
    //     chart = chartContainer.chart;
    //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //     _chartState = key.currentState as SfCartesianChartState?;
    ...
    //       (WidgetTester tester) async {
    //     final _LineDateTime chartContainer =
    //         _lineDateTime('datetime_rangepadding_none') as _LineDateTime;
    //     await tester.pumpWidget(chartContainer);
    //     chart = chartContainer.chart;
    //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //     _chartState = key.currentState as SfCartesianChartState?;
    ...
    //       (WidgetTester tester) async {
    //     final _LineDateTime chartContainer =
    //         _lineDateTime('datetime_rangepadding_auto') as _LineDateTime;
    //     await tester.pumpWidget(chartContainer);
    //     chart = chartContainer.chart;
    //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  group('Line Date Time - Grids, Ticks and Axis Elements', () {
    testWidgets('DateTime axis - EdgeLabelPlacement',
        (WidgetTester tester) async {
      final _LineDateTime chartContainer =
          _lineDateTime('datetime_edgelabelPlacement_hide') as _LineDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('DateTime Axis - Axis Line and Title',
        (WidgetTester tester) async {
      final _LineDateTime chartContainer =
          _lineDateTime('datetime_axisLine_title') as _LineDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _LineDateTime chartContainer =
    //       _lineDateTime('datetime_inversed') as _LineDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _LineDateTime chartContainer =
    //       _lineDateTime('datetime_opposed') as _LineDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('DateTime Axis - Major Grid and Tick lines',
        (WidgetTester tester) async {
      final _LineDateTime chartContainer =
          _lineDateTime('datetime_gridlines') as _LineDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _LineDateTime chartContainer =
    //       _lineDateTime('datetime_labelStyle') as _LineDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _LineDateTime chartContainer =
    //       _lineDateTime('datetime_axisVisible') as _LineDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
...
StatelessWidget _lineDateTime(String sampleName) {
  return _LineDateTime(sampleName);
}

// ignore: must_be_immutable
class _LineDateTime extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _LineDateTime(String sampleName) {
