...
/// Testing method for data time axis of the area series.
void areaDateTimeAxis() {
  ...
  group('Date Time Axis - Defualt Properties', () {
    testWidgets('DateTime axis - Default', (WidgetTester tester) async {
      final _AreaDateTime chartContainer =
          _areaDateTime('datetime_default') as _AreaDateTime;
  ...
  group('DateTime Range', () {
    testWidgets('Datetime axis - With Range', (WidgetTester tester) async {
      final _AreaDateTime chartContainer =
          _areaDateTime('datetime_range') as _AreaDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      //  _chartState = key.currentState as SfCartesianChartState?;
  ...
  group('DateTime - Range Padding', () {
    testWidgets('Datetime axis - RangePadding Additional',
      ...
      final _AreaDateTime chartContainer =
          _areaDateTime('datetime_rangepadding_add') as _AreaDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
    ...
    //     (WidgetTester tester) async {
    //   final _AreaDateTime chartContainer =
    //       _areaDateTime('datetime_rangepadding_normal') as _AreaDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //     (WidgetTester tester) async {
    //   final _AreaDateTime chartContainer =
    //       _areaDateTime('datetime_rangepadding_round') as _AreaDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //     (WidgetTester tester) async {
    //   final _AreaDateTime chartContainer =
    //       _areaDateTime('datetime_rangepadding_none') as _AreaDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //     (WidgetTester tester) async {
    //   final _AreaDateTime chartContainer =
    //       _areaDateTime('datetime_rangepadding_auto') as _AreaDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
  ...
  //       (WidgetTester tester) async {
  //     final _AreaDateTime chartContainer =
  //         _areaDateTime('datetime_edgelabelPlacement_hide') as _AreaDateTime;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  group('Date Time Axis Elements', () {
    testWidgets('DateTime Axis - Axis Line and Title',
        (WidgetTester tester) async {
      final _AreaDateTime chartContainer =
          _areaDateTime('datetime_axisLine_title') as _AreaDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      //_chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _AreaDateTime chartContainer =
    //       _areaDateTime('datetime_inversed') as _AreaDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _AreaDateTime chartContainer =
    //       _areaDateTime('datetime_opposed') as _AreaDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('DateTime Axis - Major Grid and Tick lines',
        (WidgetTester tester) async {
      final _AreaDateTime chartContainer =
          _areaDateTime('datetime_gridlines') as _AreaDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      //  final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      //_chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('DateTime Axis - Label Style', (WidgetTester tester) async {
      final _AreaDateTime chartContainer =
          _areaDateTime('datetime_labelStyle') as _AreaDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _AreaDateTime chartContainer =
    //       _areaDateTime('datetime_axisVisible') as _AreaDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
...
StatelessWidget _areaDateTime(String sampleName) {
  return _AreaDateTime(sampleName);
}

// ignore: must_be_immutable
class _AreaDateTime extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _AreaDateTime(String sampleName) {
