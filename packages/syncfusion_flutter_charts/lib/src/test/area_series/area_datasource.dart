...
/// Testing method of area series data source.
void areaDataSource() {
...
// chart instance will get once pumpWidget is called
  ...
  group('Area Series with DataSource', () {
    ...
    testWidgets('Chart Widget - Testing Area series Data Source',
      ...
      final _AreaDataSource chartContainer =
          _areaDataSource('customization_pointColor') as _AreaDataSource;
...
//         (WidgetTester tester) async {
//       final _AreaDataSource chartContainer =
//           _areaDataSource('dataSource_emptyPoint_gap') as _AreaDataSource;
//       await tester.pumpWidget(chartContainer);
//       chart = chartContainer.chart;
//       // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
//       // _chartState = key.currentState as SfCartesianChartState?;
...
//         (WidgetTester tester) async {
//       final _AreaDataSource chartContainer =
//           _areaDataSource('dataSource_emptyPoint_zero') as _AreaDataSource;
//       await tester.pumpWidget(chartContainer);
//       chart = chartContainer.chart;
//       // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
//       // _chartState = key.currentState as SfCartesianChartState?;
...
//     //     (WidgetTester tester) async {
//     //   final _AreaDataSource chartContainer =
//     //       _areaDataSource('dataSource_emptyPoint_avg') as _AreaDataSource;
//     //   await tester.pumpWidget(chartContainer);
//     //   chart = chartContainer.chart;
//     //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
//     //   _chartState = key.currentState as SfCartesianChartState?;
...
//         (WidgetTester tester) async {
//       final _AreaDataSource chartContainer =
//           _areaDataSource('dataSource_emptyPoint_drop') as _AreaDataSource;
//       await tester.pumpWidget(chartContainer);
//       chart = chartContainer.chart;
//       // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
//       // _chartState = key.currentState as SfCartesianChartState?;
...
//         (WidgetTester tester) async {
//       final _AreaDataSource chartContainer =
//           _areaDataSource('dataSource_emptyPoint_null') as _AreaDataSource;
//       await tester.pumpWidget(chartContainer);
//       chart = chartContainer.chart;
//       final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
//       _chartState = key.currentState as SfCartesianChartState?;
...
StatelessWidget _areaDataSource(String sampleName) {
  return _AreaDataSource(sampleName);
}

// ignore: must_be_immutable
class _AreaDataSource extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _AreaDataSource(String sampleName) {
