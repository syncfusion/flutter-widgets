...
/// Testing method for date time axis of the column series.
void columnDateTimeAxis() {
  ...
  group('Column Date Time - Range and Range Padding', () {
    testWidgets('DateTime axis - Default', (WidgetTester tester) async {
      final _ColumnDateTime chartContainer =
          _columnDateTime('datetime_default') as _ColumnDateTime;
    ...
    testWidgets('Datetime axis - With Range', (WidgetTester tester) async {
      final _ColumnDateTime chartContainer =
          _columnDateTime('datetime_range') as _ColumnDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    ...
    testWidgets('Datetime axis - RangePadding Additional',
      ...
      final _ColumnDateTime chartContainer =
          _columnDateTime('datetime_rangepadding_add') as _ColumnDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('Datetime axis - RangePadding Normal',
        (WidgetTester tester) async {
      final _ColumnDateTime chartContainer =
          _columnDateTime('datetime_rangepadding_normal') as _ColumnDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
    ...
    //     (WidgetTester tester) async {
    //   final _ColumnDateTime chartContainer =
    //       _columnDateTime('datetime_rangepadding_round') as _ColumnDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   // _chartState = key.currentState as SfCartesianChartState?;
    ...
    //     (WidgetTester tester) async {
    //   final _ColumnDateTime chartContainer =
    //       _columnDateTime('datetime_rangepadding_none') as _ColumnDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   // _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('Datetime axis - RangePadding Auto',
        (WidgetTester tester) async {
      final _ColumnDateTime chartContainer =
          _columnDateTime('datetime_rangepadding_auto') as _ColumnDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
  ...
  group('Column Date Time - Grids, Ticks and Axis Elements', () {
    testWidgets('DateTime axis - EdgeLabelPlacement',
        (WidgetTester tester) async {
      final _ColumnDateTime chartContainer =
          _columnDateTime('datetime_edgelabelPlacement_hide')
              as _ColumnDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    testWidgets('DateTime Axis - Axis Line and Title',
        (WidgetTester tester) async {
      final _ColumnDateTime chartContainer =
          _columnDateTime('datetime_axisLine_title') as _ColumnDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('DateTime axis - Inversed', (WidgetTester tester) async {
      final _ColumnDateTime chartContainer =
          _columnDateTime('datetime_inversed') as _ColumnDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('DateTime axis - Opposed', (WidgetTester tester) async {
      final _ColumnDateTime chartContainer =
          _columnDateTime('datetime_opposed') as _ColumnDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('DateTime Axis - Major Grid and Tick lines',
        (WidgetTester tester) async {
      final _ColumnDateTime chartContainer =
          _columnDateTime('datetime_gridlines') as _ColumnDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _ColumnDateTime chartContainer =
    //       _columnDateTime('datetime_labelStyle') as _ColumnDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   // _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _ColumnDateTime chartContainer =
    //       _columnDateTime('datetime_axisVisible') as _ColumnDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
...
StatelessWidget _columnDateTime(String sampleName) {
  return _ColumnDateTime(sampleName);
}

// ignore: must_be_immutable
class _ColumnDateTime extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _ColumnDateTime(String sampleName) {
