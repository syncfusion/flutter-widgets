...
/// Test method of category axis of the stacked line 100 series.
void stackedLine100CategoryAxis() {
  ...
  group('Stacked Line Category - Defualt Properties', () {
    testWidgets('Category axis - Default', (WidgetTester tester) async {
      final _StackedLine100Category chartContainer =
          _stackedLine100Category('category_default')
              as _StackedLine100Category;
...
// to test series count
    ...
    //   final _StackedLine100Category chartContainer =
    //       _stackedLine100Category('category_labelPlacement')
    //           as _StackedLine100Category;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
  ...
  group('Bar Category - Axis Elements', () {
    ...
    //     final _StackedLine100Category chartContainer =
    //         _stackedLine100Category('category_EdgeLabelPlacement')
    //             as _StackedLine100Category;
    //     await tester.pumpWidget(chartContainer);
    //     chart = chartContainer.chart;
    //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    //     final _StackedLine100Category chartContainer =
    //         _stackedLine100Category('category_inversed')
    //             as _StackedLine100Category;
    //     await tester.pumpWidget(chartContainer);
    //     chart = chartContainer.chart;
    //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    //     final _StackedLine100Category chartContainer =
    //         _stackedLine100Category('category_opposed')
    //             as _StackedLine100Category;
    //     await tester.pumpWidget(chartContainer);
    //     chart = chartContainer.chart;
    //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    testWidgets('Category Axis - Label and Tick Position',
        (WidgetTester tester) async {
      final _StackedLine100Category chartContainer =
          _stackedLine100Category('category_label_tickPosition')
              as _StackedLine100Category;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('Category Axis - Major Grid and Tick lines',
        (WidgetTester tester) async {
      final _StackedLine100Category chartContainer =
          _stackedLine100Category('category_gridlines')
              as _StackedLine100Category;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('Category Axis - Label Style', (WidgetTester tester) async {
      final _StackedLine100Category chartContainer =
          _stackedLine100Category('category_labelStyle')
              as _StackedLine100Category;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('Category Axis - Visibility', (WidgetTester tester) async {
      final _StackedLine100Category chartContainer =
          _stackedLine100Category('category_axisVisible')
              as _StackedLine100Category;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('Category Axis - Axis Line', (WidgetTester tester) async {
      final _StackedLine100Category chartContainer =
          _stackedLine100Category('category_axisLine_title')
              as _StackedLine100Category;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
...
StatelessWidget _stackedLine100Category(String sampleName) {
  return _StackedLine100Category(sampleName);
}

// ignore: must_be_immutable
class _StackedLine100Category extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _StackedLine100Category(String sampleName) {
