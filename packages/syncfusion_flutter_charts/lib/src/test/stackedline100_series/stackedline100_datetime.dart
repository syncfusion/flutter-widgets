...
/// Test method for date time axis of the stacked line 100 series.
void stackedLine100DateTimeAxis() {
  ...
  group('Column Date Time - Range and Range Padding', () {
    testWidgets('DateTime axis - Default', (WidgetTester tester) async {
      final _StackedLine100DateTime chartContainer =
          _stackedLine100DateTime('datetime_default')
              as _StackedLine100DateTime;
    ...
    //   final _StackedLine100DateTime chartContainer =
    //       _stackedLine100DateTime('datetime_range') as _StackedLine100DateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    ...
    //   final _StackedLine100DateTime chartContainer =
    //       _stackedLine100DateTime('datetime_rangepadding_add')
    //           as _StackedLine100DateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    //     (WidgetTester tester) async {
    //   final _StackedLine100DateTime chartContainer =
    //       _stackedLine100DateTime('datetime_rangepadding_normal')
    //           as _StackedLine100DateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    //     (WidgetTester tester) async {
    //   final _StackedLine100DateTime chartContainer =
    //       _stackedLine100DateTime('datetime_rangepadding_round')
    //           as _StackedLine100DateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    //     (WidgetTester tester) async {
    //   final _StackedLine100DateTime chartContainer =
    //       _stackedLine100DateTime('datetime_rangepadding_none')
    //           as _StackedLine100DateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    //     (WidgetTester tester) async {
    //   final _StackedLine100DateTime chartContainer =
    //       _stackedLine100DateTime('datetime_rangepadding_auto')
    //           as _StackedLine100DateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  group('Column Date Time - Grids, Ticks and Axis Elements', () {
    ...
    //     (WidgetTester tester) async {
    //   final _StackedLine100DateTime chartContainer =
    //       _stackedLine100DateTime('datetime_edgelabelPlacement_hide')
    //           as _StackedLine100DateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    testWidgets('DateTime Axis - Axis Line and Title',
        (WidgetTester tester) async {
      final _StackedLine100DateTime chartContainer =
          _stackedLine100DateTime('datetime_axisLine_title')
              as _StackedLine100DateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    //   final _StackedLine100DateTime chartContainer =
    //       _stackedLine100DateTime('datetime_inversed')
    //           as _StackedLine100DateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    //   final _StackedLine100DateTime chartContainer =
    //       _stackedLine100DateTime('datetime_opposed')
    //           as _StackedLine100DateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    testWidgets('DateTime Axis - Major Grid and Tick lines',
        (WidgetTester tester) async {
      final _StackedLine100DateTime chartContainer =
          _stackedLine100DateTime('datetime_gridlines')
              as _StackedLine100DateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    //   final _StackedLine100DateTime chartContainer =
    //       _stackedLine100DateTime('datetime_labelStyle')
    //           as _StackedLine100DateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    //   final _StackedLine100DateTime chartContainer =
    //       _stackedLine100DateTime('datetime_axisVisible')
    //           as _StackedLine100DateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
...
StatelessWidget _stackedLine100DateTime(String sampleName) {
  return _StackedLine100DateTime(sampleName);
}

// ignore: must_be_immutable
class _StackedLine100DateTime extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _StackedLine100DateTime(String sampleName) {
