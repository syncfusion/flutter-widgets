...
SfCartesianChart getStackedlinePerformanceChart(
  ...
  switch (sampleName) {
    case 'default_stackedline':
      chart = SfCartesianChart(
          key: GlobalKey<State<SfCartesianChart>>(),
          series: <StackedLineSeries<PerformanceData, num?>>[
            StackedLineSeries<PerformanceData, num?>(
              dataSource: data,
              animationDuration: 0,
    ...
    case 'stackedline_with_marker':
      ...
      break;
    case 'stackedline_with_datalabel':
      chart = SfCartesianChart(
          key: GlobalKey<State<SfCartesianChart>>(),
          series: <StackedLineSeries<PerformanceData, num?>>[
            StackedLineSeries<PerformanceData, num?>(
