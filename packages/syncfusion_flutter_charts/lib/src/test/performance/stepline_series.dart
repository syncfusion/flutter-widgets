...
/// Method to get the step line performance sample
SfCartesianChart getSteplinePerformanceChart(
  ...
  switch (sampleName) {
    case 'default_stepline':
      chart = SfCartesianChart(
          key: GlobalKey<State<SfCartesianChart>>(),
          series: <StepLineSeries<PerformanceData, num?>>[
            StepLineSeries<PerformanceData, num?>(
              dataSource: data,
              animationDuration: 0,
