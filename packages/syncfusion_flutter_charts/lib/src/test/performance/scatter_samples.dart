...
/// Method to get the scatter performance sample
SfCartesianChart getScatterPerformanceChart(
  ...
  switch (sampleName) {
    case 'default_scatter':
      chart = SfCartesianChart(
          key: GlobalKey<State<SfCartesianChart>>(),
          series: <ScatterSeries<PerformanceData, num?>>[
            ScatterSeries<PerformanceData, num?>(
              dataSource: data,
              animationDuration: 0,
