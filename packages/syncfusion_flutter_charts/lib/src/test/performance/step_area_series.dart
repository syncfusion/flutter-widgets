...
/// Method to get the step area performance sample
SfCartesianChart getStepareaPerformanceChart(
  ...
  switch (sampleName) {
    case 'default_steparea':
      chart = SfCartesianChart(
          key: GlobalKey<State<SfCartesianChart>>(),
          series: <StepAreaSeries<PerformanceData, num?>>[
            StepAreaSeries<PerformanceData, num?>(
              dataSource: data,
              animationDuration: 0,
