...
/// Method to get the bar performance sample
SfCartesianChart getBarPerformanceChart(String sampleName, int noOfSamples) {
  ...
  switch (sampleName) {
    case 'default_bar':
      chart = SfCartesianChart(
          ...
          series: <BarSeries<PerformanceData, num?>>[
            BarSeries<PerformanceData, num?>(
              dataSource: data,
              animationDuration: 0,
