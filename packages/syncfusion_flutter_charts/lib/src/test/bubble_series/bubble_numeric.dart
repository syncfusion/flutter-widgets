...
/// Test method for numeric axis of the bubble series.
void bubbleNumericAxis() {
  ...
  group('Bubble Numeric - Range and Range Padding', () {
    testWidgets('Numeric axis - Default', (WidgetTester tester) async {
      final _BubbleNumeric chartContainer =
          _bubbleNumeric('numeric_default') as _BubbleNumeric;
    ...
    // Bubble series with data
    testWidgets('Numeric axis - With Data', (WidgetTester tester) async {
      final _BubbleNumeric chartContainer =
          _bubbleNumeric('numeric_defaultData') as _BubbleNumeric;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('Numeric axis - With Range', (WidgetTester tester) async {
      final _BubbleNumeric chartContainer =
          _bubbleNumeric('numeric_range') as _BubbleNumeric;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('Numeric axis - RangePadding with Additional',
      ...
      final _BubbleNumeric chartContainer =
          _bubbleNumeric('numeric_rangePadding_Add') as _BubbleNumeric;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('Numeric axis - RangePadding Normal',
        (WidgetTester tester) async {
      final _BubbleNumeric chartContainer =
          _bubbleNumeric('numeric_rangePadding_Normal') as _BubbleNumeric;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('Numeric axis - RangePadding Round',
        (WidgetTester tester) async {
      final _BubbleNumeric chartContainer =
          _bubbleNumeric('numeric_rangePadding_Round') as _BubbleNumeric;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('Numeric axis - With RangePadding Auto',
        (WidgetTester tester) async {
      final _BubbleNumeric chartContainer =
          _bubbleNumeric('numeric_rangePadding_Auto') as _BubbleNumeric;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('Numeric axis - RangePadding None',
        (WidgetTester tester) async {
      final _BubbleNumeric chartContainer =
          _bubbleNumeric('numeric_rangePadding_None') as _BubbleNumeric;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
  ...
  group('Bubble Numeric - Grids, Ticks and Axis Elements', () {
    testWidgets('Numeric Axis - Axis Line and Title',
        (WidgetTester tester) async {
      final _BubbleNumeric chartContainer =
          _bubbleNumeric('numeric_axisLine_title') as _BubbleNumeric;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('Numeric axis - Inversed', (WidgetTester tester) async {
      final _BubbleNumeric chartContainer =
          _bubbleNumeric('numeric_inversed') as _BubbleNumeric;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('Numeric axis - Opposed', (WidgetTester tester) async {
      final _BubbleNumeric chartContainer =
          _bubbleNumeric('numeric_opposed') as _BubbleNumeric;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('Numeric Axis - Major Grid and Tick lines',
        (WidgetTester tester) async {
      final _BubbleNumeric chartContainer =
          _bubbleNumeric('numeric_gridlines') as _BubbleNumeric;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('Numeric Axis - Label Style', (WidgetTester tester) async {
      final _BubbleNumeric chartContainer =
          _bubbleNumeric('numeric_labelStyle') as _BubbleNumeric;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
      // final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
      // _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _BubbleNumeric chartContainer =
    //       _bubbleNumeric('numeric_axisVisible') as _BubbleNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //     (WidgetTester tester) async {
    //   final _BubbleNumeric chartContainer =
    //       _bubbleNumeric('numeric_edgelabelPlacement_hide') as _BubbleNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
...
StatelessWidget _bubbleNumeric(String sampleName) {
  return _BubbleNumeric(sampleName);
}

// ignore: must_be_immutable
class _BubbleNumeric extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _BubbleNumeric(String sampleName) {
