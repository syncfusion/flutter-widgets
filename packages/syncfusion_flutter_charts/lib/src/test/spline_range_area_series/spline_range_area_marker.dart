...
/// Test method for markers in the spline range area series.
void splineRangeAreaMarker() {
  ...
  group('RangeArea Series - Marker', () {
    testWidgets('Chart Widget - Testing RangeArea Series with Marker',
      ...
      final _SplineRangeAreaMarker chartContainer =
          _splinerangeAreaMarker('marker_default') as _SplineRangeAreaMarker;
    ...
    testWidgets(
        ...
        (WidgetTester tester) async {
      final _SplineRangeAreaMarker chartContainer =
          _splinerangeAreaMarker('marker_cutomization')
              as _SplineRangeAreaMarker;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets(
        ...
        (WidgetTester tester) async {
      final _SplineRangeAreaMarker chartContainer =
          _splinerangeAreaMarker('marker_EmptyPoint') as _SplineRangeAreaMarker;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
...
StatelessWidget _splinerangeAreaMarker(String sampleName) {
  return _SplineRangeAreaMarker(sampleName);
}

// ignore: must_be_immutable
class _SplineRangeAreaMarker extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _SplineRangeAreaMarker(String sampleName) {
