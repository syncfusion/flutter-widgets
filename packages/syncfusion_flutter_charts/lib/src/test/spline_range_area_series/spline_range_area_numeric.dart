...
/// Test method for numeric axis of the spline range area series.
void splinerangeAreaNumericAxis() {
  ...
  group('splineArea Series - Numeric Axis Default properties', () {
    testWidgets('Numeric axis - Default', (WidgetTester tester) async {
      final _SplineRangeAreaNumeric chartContainer =
          _splineRangeAreaNumeric('numeric_default') as _SplineRangeAreaNumeric;
    ...
    //   final _SplineRangeAreaNumeric chartContainer =
    //       _splineRangeAreaNumeric('numeric_defaultData')
    //           as _SplineRangeAreaNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
  ...
  // group('spline Area Series - spline and spline Padding', () {
  //   testWidgets('Numeric axis - With spline', (WidgetTester tester) async {
  //     final _SplineRangeAreaNumeric chartContainer =
  //         _splineRangeAreaNumeric('numeric_SplineRange')
  //             as _SplineRangeAreaNumeric;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  //   testWidgets('Numeric axis - splinePadding with Additional',
  //       (WidgetTester tester) async {
  //     final _SplineRangeAreaNumeric chartContainer =
  //         _splineRangeAreaNumeric('numeric_rangePadding_Add')
  //             as _SplineRangeAreaNumeric;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  //   testWidgets('Numeric axis - splinePadding Normal',
  //       (WidgetTester tester) async {
  //     final _SplineRangeAreaNumeric chartContainer =
  //         _splineRangeAreaNumeric('numeric_rangePadding_Normal')
  //             as _SplineRangeAreaNumeric;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  //   testWidgets('Numeric axis - splinePadding Round',
  //       (WidgetTester tester) async {
  //     final _SplineRangeAreaNumeric chartContainer =
  //         _splineRangeAreaNumeric('numeric_rangePadding_Round')
  //             as _SplineRangeAreaNumeric;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  //       (WidgetTester tester) async {
  //     final _SplineRangeAreaNumeric chartContainer =
  //         _splineRangeAreaNumeric('numeric_rangePadding_Auto')
  //             as _SplineRangeAreaNumeric;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  //       (WidgetTester tester) async {
  //     final _SplineRangeAreaNumeric chartContainer =
  //         _splineRangeAreaNumeric('numeric_rangePadding_None')
  //             as _SplineRangeAreaNumeric;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  // group('RangeArea Series - Numeric - Edge Label Placement', () {
  //   testWidgets('Numeric axis - EdgeLabelPlacement',
  //       (WidgetTester tester) async {
  //     final _SplineRangeAreaNumeric chartContainer =
  //         _splineRangeAreaNumeric('numeric_edgelabelPlacement_hide')
  //             as _SplineRangeAreaNumeric;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  group('Range Area Series - Numeric - Axis Elements', () {
    // testWidgets('Numeric Axis - Visibility', (WidgetTester tester) async {
    //   final _SplineRangeAreaNumeric chartContainer =
    //       _splineRangeAreaNumeric('numeric_axisVisible')
    //           as _SplineRangeAreaNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    testWidgets('Numeric Axis - Axis Line and Title',
        (WidgetTester tester) async {
      final _SplineRangeAreaNumeric chartContainer =
          _splineRangeAreaNumeric('numeric_axisLine_title')
              as _SplineRangeAreaNumeric;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    //   final _SplineRangeAreaNumeric chartContainer =
    //       _splineRangeAreaNumeric('numeric_inversed')
    //           as _SplineRangeAreaNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    //   final _SplineRangeAreaNumeric chartContainer =
    //       _splineRangeAreaNumeric('numeric_opposed') as _SplineRangeAreaNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
  ...
  group('Range Area Series - Numeric - Major Grid and Line', () {
    testWidgets('Numeric Axis - Major Grid and Tick lines',
        (WidgetTester tester) async {
      final _SplineRangeAreaNumeric chartContainer =
          _splineRangeAreaNumeric('numeric_gridlines')
              as _SplineRangeAreaNumeric;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('Numeric Axis - Label Style', (WidgetTester tester) async {
      final _SplineRangeAreaNumeric chartContainer =
          _splineRangeAreaNumeric('numeric_labelStyle')
              as _SplineRangeAreaNumeric;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
...
StatelessWidget _splineRangeAreaNumeric(String sampleName) {
  return _SplineRangeAreaNumeric(sampleName);
}

// ignore: must_be_immutable
class _SplineRangeAreaNumeric extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _SplineRangeAreaNumeric(String sampleName) {
