...
/// Test method for date time axis of the spline range area series.
void splinerangeAreaDateTimeAxis() {
  ...
  group('RangeArea - Date Time Axis - Defualt Properties', () {
    testWidgets('DateTime axis - Default', (WidgetTester tester) async {
      final _SplineRangeAreaDateTime chartContainer =
          _splineRangeAreaDateTime('datetime_default')
              as _SplineRangeAreaDateTime;
    ...
    //     final _SplineRangeAreaDateTime chartContainer =
    //         _splineRangeAreaDateTime('datetime_range')
    //             as _SplineRangeAreaDateTime;
    //     await tester.pumpWidget(chartContainer);
    //     chart = chartContainer.chart;
  ...
  group('DateTime - Range Padding', () {
    testWidgets('Datetime axis - RangePadding Additional',
      ...
      final _SplineRangeAreaDateTime chartContainer =
          _splineRangeAreaDateTime('datetime_rangepadding_add')
              as _SplineRangeAreaDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    //     (WidgetTester tester) async {
    //   final _SplineRangeAreaDateTime chartContainer =
    //       _splineRangeAreaDateTime('datetime_rangepadding_normal')
    //           as _SplineRangeAreaDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    //     (WidgetTester tester) async {
    //   final _SplineRangeAreaDateTime chartContainer =
    //       _splineRangeAreaDateTime('datetime_rangepadding_round')
    //           as _SplineRangeAreaDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    //     (WidgetTester tester) async {
    //   final _SplineRangeAreaDateTime chartContainer =
    //       _splineRangeAreaDateTime('datetime_rangepadding_none')
    //           as _SplineRangeAreaDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    //     (WidgetTester tester) async {
    //   final _SplineRangeAreaDateTime chartContainer =
    //       _splineRangeAreaDateTime('datetime_rangepadding_auto')
    //           as _SplineRangeAreaDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  //       (WidgetTester tester) async {
  //     final _SplineRangeAreaDateTime chartContainer =
  //         _splineRangeAreaDateTime('datetime_edgelabelPlacement_hide')
  //             as _SplineRangeAreaDateTime;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  group('Date Time Axis Elements', () {
    testWidgets('DateTime Axis - Axis Line and Title',
        (WidgetTester tester) async {
      final _SplineRangeAreaDateTime chartContainer =
          _splineRangeAreaDateTime('datetime_axisLine_title')
              as _SplineRangeAreaDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('DateTime axis - Inversed', (WidgetTester tester) async {
      final _SplineRangeAreaDateTime chartContainer =
          _splineRangeAreaDateTime('datetime_inversed')
              as _SplineRangeAreaDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    //   final _SplineRangeAreaDateTime chartContainer =
    //       _splineRangeAreaDateTime('datetime_opposed')
    //           as _SplineRangeAreaDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    testWidgets('DateTime Axis - Major Grid and Tick lines',
        (WidgetTester tester) async {
      final _SplineRangeAreaDateTime chartContainer =
          _splineRangeAreaDateTime('datetime_gridlines')
              as _SplineRangeAreaDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    //     final _SplineRangeAreaDateTime chartContainer =
    //         _splineRangeAreaDateTime('datetime_labelStyle')
    //             as _SplineRangeAreaDateTime;
    //     await tester.pumpWidget(chartContainer);
    //     chart = chartContainer.chart;
    //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    //     final _SplineRangeAreaDateTime chartContainer =
    //         _splineRangeAreaDateTime('datetime_axisVisible')
    //             as _SplineRangeAreaDateTime;
    //     await tester.pumpWidget(chartContainer);
    //     chart = chartContainer.chart;
    //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
...
StatelessWidget _splineRangeAreaDateTime(String sampleName) {
  return _SplineRangeAreaDateTime(sampleName);
}

// ignore: must_be_immutable
class _SplineRangeAreaDateTime extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _SplineRangeAreaDateTime(String sampleName) {
