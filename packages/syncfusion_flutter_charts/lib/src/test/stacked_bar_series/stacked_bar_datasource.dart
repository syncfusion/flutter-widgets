...
// /// Testing method of stacked bar series data source.
// void stackedBarDataSource() {
...
//         381.0, 334.96762589928056, 381.0, 398.16906474820144));
//     pointRegionGap1.add(const Rect.fromLTRB(46.0, 46.0, 46.0, 46.0));
//     pointRegionGap1.add(const Rect.fromLTRB(
//         423.0, 154.39208633093523, 423.0, 217.5935251798561));
//     pointRegionGap1.add(const Rect.fromLTRB(46.0, 46.0, 46.0, 46.0));

//     // testWidgets(
//     //     'Chart Widget - Testing Stacked Bar series Data Source with empty point as gap',
//     //     (WidgetTester tester) async {
//     //   final _StackedBarDataSource chartContainer =
//     //       _stackedBarDataSource('emptyPoint_gap') as _StackedBarDataSource;
...
//     pointRegionZero1.add(const Rect.fromLTRB(381.0, 381.0, 381.0, 381.0));
//     pointRegionZero1.add(const Rect.fromLTRB(46.0, 46.0, 46.0, 46.0));
//     pointRegionZero1.add(const Rect.fromLTRB(423.0, 423.0, 423.0, 423.0));
//     pointRegionZero1.add(const Rect.fromLTRB(46.0, 46.0, 46.0, 46.0));

//     // Line series with
//     // testWidgets(
//     //     'Chart Widget - Testing Stacked Bar series Data Source with empty point as zero',
//     //     (WidgetTester tester) async {
//     //   final _StackedBarDataSource chartContainer =
//     //       _stackedBarDataSource('emptyPoint_zero') as _StackedBarDataSource;
//     //   await tester.pumpWidget(chartContainer);
//     //   chart = chartContainer.chart;
//     //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
//     //   _chartState = key.currentState as SfCartesianChartState?;
...
//     // testWidgets(
//     //     'Chart Widget - Testing Stacked Bar series Data Source with empty point as average',
//     //     (WidgetTester tester) async {
//     //   final _StackedBarDataSource chartContainer =
//     //       _stackedBarDataSource('emptyPoint_avg') as _StackedBarDataSource;
//     //   await tester.pumpWidget(chartContainer);
//     //   chart = chartContainer.chart;
//     //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
//     //   _chartState = key.currentState as SfCartesianChartState?;
...
//     testWidgets(
//         'Chart Widget - Testing Stacked Bar series Data Source with empty point as drop',
//         (WidgetTester tester) async {
//       final _StackedBarDataSource chartContainer =
//           _stackedBarDataSource('emptyPoint_drop') as _StackedBarDataSource;
//       await tester.pumpWidget(chartContainer);
//       chart = chartContainer.chart;
//       final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
//       _chartState = key.currentState as SfCartesianChartState?;
...
//     testWidgets(
//         'Chart Widget - Testing Stacked Bar series Data Source with empty point as null',
//         (WidgetTester tester) async {
//       final _StackedBarDataSource chartContainer =
//           _stackedBarDataSource('null') as _StackedBarDataSource;
//       await tester.pumpWidget(chartContainer);
//       chart = chartContainer.chart;
//       final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
//       _chartState = key.currentState as SfCartesianChartState?;
...
// StatelessWidget _stackedBarDataSource(String sampleName) {
//   return _StackedBarDataSource(sampleName);
// }

// // ignore: must_be_immutable
// class _StackedBarDataSource extends StatelessWidget {
//   // ignore: prefer_const_constructors_in_immutables
//   _StackedBarDataSource(String sampleName) {
