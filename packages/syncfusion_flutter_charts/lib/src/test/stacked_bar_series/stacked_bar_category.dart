...
/// Test method of category axis of the stacked bar series.
void stackedBarCategoryAxis() {
  ...
  group('Stacked Bar Category - Defualt Properties', () {
    testWidgets('Category axis - Default', (WidgetTester tester) async {
      final _StackedBarCategory chartContainer =
          _stackedBarCategory('category_default') as _StackedBarCategory;
...
// to test series count
    ...
    //   final _StackedBarCategory chartContainer =
    //       _stackedBarCategory('category_labelPlacement') as _StackedBarCategory;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
  ...
  group('Stacked Bar Category - Axis Elements', () {
    // testWidgets('Category axis - EdgeLabelPlacement',
    //     (WidgetTester tester) async {
    //   final _StackedBarCategory chartContainer =
    //       _stackedBarCategory('category_EdgeLabelPlacement')
    //           as _StackedBarCategory;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _StackedBarCategory chartContainer =
    //       _stackedBarCategory('category_inversed') as _StackedBarCategory;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _StackedBarCategory chartContainer =
    //       _stackedBarCategory('category_opposed') as _StackedBarCategory;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('Category Axis - Label and Tick Position',
        (WidgetTester tester) async {
      final _StackedBarCategory chartContainer =
          _stackedBarCategory('category_label_tickPosition')
              as _StackedBarCategory;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('Category Axis - Major Grid and Tick lines',
        (WidgetTester tester) async {
      final _StackedBarCategory chartContainer =
          _stackedBarCategory('category_gridlines') as _StackedBarCategory;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('Category Axis - Label Style', (WidgetTester tester) async {
      final _StackedBarCategory chartContainer =
          _stackedBarCategory('category_labelStyle') as _StackedBarCategory;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('Category Axis - Visibility', (WidgetTester tester) async {
      final _StackedBarCategory chartContainer =
          _stackedBarCategory('category_axisVisible') as _StackedBarCategory;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('Category Axis - Axis Line', (WidgetTester tester) async {
      final _StackedBarCategory chartContainer =
          _stackedBarCategory('category_axisLine_title') as _StackedBarCategory;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
...
StatelessWidget _stackedBarCategory(String sampleName) {
  return _StackedBarCategory(sampleName);
}

// ignore: must_be_immutable
class _StackedBarCategory extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _StackedBarCategory(String sampleName) {
