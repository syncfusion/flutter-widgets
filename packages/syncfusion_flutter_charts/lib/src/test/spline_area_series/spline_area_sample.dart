...
/// Returns the spline area chart sample
SfCartesianChart getSplineAreachart(String sampleName) {
  SfCartesianChart chart;
  final dynamic data = <SplineAreaData>[
    SplineAreaData(DateTime(2005, 0), 'India', 1.5, 32, 28, 680, 760, 1,
        Colors.deepOrange),
    SplineAreaData(DateTime(2006, 0), 'China', 2.2, 24, 44, 550, 880, 2,
        Colors.deepPurple),
    SplineAreaData(
  ...
  switch (sampleName) {
    case 'customization_default':
      chart = SfCartesianChart(
          ...
          series: getSplineAreaDefaultData());
      break;
    case 'customization_fill':
      chart = SfCartesianChart(
          key: GlobalKey<State<SfCartesianChart>>(),
          legend: Legend(isVisible: true),
          series: <SplineAreaSeries<SplineAreaData, num>>[
            SplineAreaSeries<SplineAreaData, num>(
                enableTooltip: true,
                dataSource: data,
                xValueMapper: (SplineAreaData sales, _) => sales.numeric,
                yValueMapper: (SplineAreaData sales, _) => sales.sales1,
                color: Colors.blue,
    ...
    case 'sortingX':
      chart = SfCartesianChart(
          ...
          series: <SplineAreaSeries<SplineAreaData, String>>[
            SplineAreaSeries<SplineAreaData, String>(
                dataSource: data,
                xValueMapper: (SplineAreaData sales, _) => sales.category,
                yValueMapper: (SplineAreaData sales, _) => sales.sales1,
                sortFieldValueMapper: (SplineAreaData sales, _) =>
                    sales.category,
          ...
          series: <SplineAreaSeries<SplineAreaData, num>>[
            SplineAreaSeries<SplineAreaData, num>(
                ...
                dataSource: <SplineAreaData>[
                  SplineAreaData(DateTime(2005, 0), 'India', 1.5, 32, 28, 680,
                      760, 1, Colors.deepOrange),
                  SplineAreaData(DateTime(2006, 0), 'China', 2.2, null, 44, 550,
                      880, 2, Colors.deepPurple),
                  SplineAreaData(DateTime(2007, 0), 'USA', 3.32, 36, 48, 440,
                      788, 3, Colors.lightGreen),
                  SplineAreaData(DateTime(2008, 0), 'Japan', 4.56, 38, 50, 350,
                      560, 4, Colors.red),
                  SplineAreaData(DateTime(2009, 0), 'Russia', 5.87, null, 66,
      ...
      chart = SfCartesianChart(
          ...
          series: <SplineAreaSeries<SplineAreaData, num>>[
            SplineAreaSeries<SplineAreaData, num>(
              enableTooltip: true,
              dataSource: <SplineAreaData>[
                SplineAreaData(DateTime(2005, 0), 'India', 1.5, null, 28, 680,
                    760, 1, Colors.deepOrange),
                SplineAreaData(DateTime(2006, 0), 'China', 2.2, null, 44, 550,
                    880, 2, Colors.deepPurple),
                SplineAreaData(DateTime(2007, 0), 'USA', 3.32, null, 48, 440,
                    788, 3, Colors.lightGreen),
                SplineAreaData(DateTime(2008, 0), 'Japan', 4.56, null, 50, 350,
                    560, 4, Colors.red),
                SplineAreaData(DateTime(2009, 0), 'Russia', 5.87, null, 66, 444,
                    566, 5, Colors.purple)
              ],
              xValueMapper: (SplineAreaData sales, _) => sales.numeric,
              yValueMapper: (SplineAreaData sales, _) => sales.sales1,
    ...
    case 'numeric_defaultData':
      chart = SfCartesianChart(
          key: GlobalKey<State<SfCartesianChart>>(),
          series: <SplineAreaSeries<SplineAreaData, int>>[
            SplineAreaSeries<SplineAreaData, int>(
              dataSource: data,
              xValueMapper: (SplineAreaData sales, _) => sales.xData,
              yValueMapper: (SplineAreaData sales, _) => sales.sales1,
            ),
          ]);
      break;
    ...
    case 'datetime_default':
      chart = SfCartesianChart(
          ...
          series: <SplineAreaSeries<SplineAreaData, DateTime>>[
            SplineAreaSeries<SplineAreaData, DateTime>(
              dataSource: data,
...
/// Returns the spline area default data
List<SplineAreaSeries<SplineAreaData, num>> getSplineAreaDefaultData() {
  final dynamic chartData = <SplineAreaData>[
    SplineAreaData(DateTime(2005, 0), 'India', 1.5, null, 28, 680, 7601, 1),
    SplineAreaData(DateTime(2006, 0), 'China', 2.2, 24, 44, 550, 880, 2),
    SplineAreaData(DateTime(2007, 0), 'USA', 3.32, 36, 48, 440, 788, 3),
    SplineAreaData(DateTime(2008, 0), 'Japan', 4.56, 38, 50, 350, 560, 4),
    SplineAreaData(DateTime(2009, 0), 'Russia', 5.87, 54, 66, 444, 566, 5),
    SplineAreaData(DateTime(2010, 0), 'France', 6.8, 57, 78, 780, 650, 6),
    SplineAreaData(DateTime(2011, 0), 'Germany', 8.5, 70, 84, 450, 800, 7)
  ];
  return <SplineAreaSeries<SplineAreaData, num>>[
    SplineAreaSeries<SplineAreaData, num>(
      enableTooltip: true,
...
List<SplineAreaSeries<SplineAreaData, num>> getSplineAreaFillSeries() {
  final dynamic chartData = <SplineAreaData>[
    SplineAreaData(DateTime(2005, 0), 'India', 1.5, null, 28, 680, 760, 1),
    SplineAreaData(DateTime(2006, 0), 'China', 2.2, 24, 44, 550, 880, 2),
    SplineAreaData(DateTime(2007, 0), 'USA', 3.32, 36, 48, 440, 788, 3),
    SplineAreaData(DateTime(2008, 0), 'Japan', 4.56, 38, 50, 350, 560, 4),
    SplineAreaData(DateTime(2009, 0), 'Russia', 5.87, 54, 66, 444, 566, 5),
...
/// Represents the spline area data
class SplineAreaData {
  /// Creates an instance of spline area data
  SplineAreaData(this.year, this.category, this.numeric, this.sales1,
