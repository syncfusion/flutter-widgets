...
/// Test method for numeric axis of the spline area series.
void splineAreaNumericAxis() {
  ...
  group('Area Series - Numeric Axis Default properties', () {
    testWidgets('Numeric axis - Default', (WidgetTester tester) async {
      final _SplineAreaNumeric chartContainer =
          _splineAreaNumeric('numeric_default') as _SplineAreaNumeric;
    ...
    //   final _SplineAreaNumeric chartContainer =
    //       _splineAreaNumeric('numeric_defaultData') as _SplineAreaNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
  ...
  //     final _SplineAreaNumeric chartContainer =
  //         _splineAreaNumeric('numeric_range') as _SplineAreaNumeric;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  //     final _SplineAreaNumeric chartContainer =
  //         _splineAreaNumeric('numeric_rangePadding_Add') as _SplineAreaNumeric;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  //       (WidgetTester tester) async {
  //     final _SplineAreaNumeric chartContainer =
  //         _splineAreaNumeric('numeric_rangePadding_Normal')
  //             as _SplineAreaNumeric;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  //       (WidgetTester tester) async {
  //     final _SplineAreaNumeric chartContainer =
  //         _splineAreaNumeric('numeric_rangePadding_Round')
  //             as _SplineAreaNumeric;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  //       (WidgetTester tester) async {
  //     final _SplineAreaNumeric chartContainer =
  //         _splineAreaNumeric('numeric_rangePadding_Auto') as _SplineAreaNumeric;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  //       (WidgetTester tester) async {
  //     final _SplineAreaNumeric chartContainer =
  //         _splineAreaNumeric('numeric_rangePadding_None') as _SplineAreaNumeric;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  //       (WidgetTester tester) async {
  //     final _SplineAreaNumeric chartContainer =
  //         _splineAreaNumeric('numeric_edgelabelPlacement_hide')
  //             as _SplineAreaNumeric;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  group('Area Series - Numeric - Axis Elements', () {
    testWidgets('Numeric Axis - Visibility', (WidgetTester tester) async {
      final _SplineAreaNumeric chartContainer =
          _splineAreaNumeric('numeric_axisVisible') as _SplineAreaNumeric;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('Numeric Axis - Axis Line and Title',
        (WidgetTester tester) async {
      final _SplineAreaNumeric chartContainer =
          _splineAreaNumeric('numeric_axisLine_title') as _SplineAreaNumeric;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('Numeric axis - Inversed', (WidgetTester tester) async {
      final _SplineAreaNumeric chartContainer =
          _splineAreaNumeric('numeric_inversed') as _SplineAreaNumeric;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    //   final _SplineAreaNumeric chartContainer =
    //       _splineAreaNumeric('numeric_opposed') as _SplineAreaNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
  ...
  group('Area Series - Numeric - Major Grid and Line', () {
    testWidgets('Numeric Axis - Major Grid and Tick lines',
        (WidgetTester tester) async {
      final _SplineAreaNumeric chartContainer =
          _splineAreaNumeric('numeric_gridlines') as _SplineAreaNumeric;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('Numeric Axis - Label Style', (WidgetTester tester) async {
      final _SplineAreaNumeric chartContainer =
          _splineAreaNumeric('numeric_labelStyle') as _SplineAreaNumeric;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
...
StatelessWidget _splineAreaNumeric(String sampleName) {
  return _SplineAreaNumeric(sampleName);
}

// ignore: must_be_immutable
class _SplineAreaNumeric extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _SplineAreaNumeric(String sampleName) {
