...
/// Test method for date time axis of the spline area series.
void splineAreaDateTimeAxis() {
  ...
  group('Date Time Axis - Defualt Properties', () {
    testWidgets('DateTime axis - Default', (WidgetTester tester) async {
      final _SplineAreaDateTime chartContainer =
          _splineAreaDateTime('datetime_default') as _SplineAreaDateTime;
  ...
  //     final _SplineAreaDateTime chartContainer =
  //         _splineAreaDateTime('datetime_range') as _SplineAreaDateTime;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  ...
  //     final _SplineAreaDateTime chartContainer =
  //         _splineAreaDateTime('datetime_rangepadding_add')
  //             as _SplineAreaDateTime;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  //       (WidgetTester tester) async {
  //     final _SplineAreaDateTime chartContainer =
  //         _splineAreaDateTime('datetime_rangepadding_normal')
  //             as _SplineAreaDateTime;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  //       (WidgetTester tester) async {
  //     final _SplineAreaDateTime chartContainer =
  //         _splineAreaDateTime('datetime_rangepadding_round')
  //             as _SplineAreaDateTime;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  //       (WidgetTester tester) async {
  //     final _SplineAreaDateTime chartContainer =
  //         _splineAreaDateTime('datetime_rangepadding_none')
  //             as _SplineAreaDateTime;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  //       (WidgetTester tester) async {
  //     final _SplineAreaDateTime chartContainer =
  //         _splineAreaDateTime('datetime_rangepadding_auto')
  //             as _SplineAreaDateTime;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  //       (WidgetTester tester) async {
  //     final _SplineAreaDateTime chartContainer =
  //         _splineAreaDateTime('datetime_edgelabelPlacement_hide')
  //             as _SplineAreaDateTime;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  group('Date Time Axis Elements', () {
    testWidgets('DateTime Axis - Axis Line and Title',
        (WidgetTester tester) async {
      final _SplineAreaDateTime chartContainer =
          _splineAreaDateTime('datetime_axisLine_title') as _SplineAreaDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    //   final _SplineAreaDateTime chartContainer =
    //       _splineAreaDateTime('datetime_inversed') as _SplineAreaDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _SplineAreaDateTime chartContainer =
    //       _splineAreaDateTime('datetime_opposed') as _SplineAreaDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('DateTime Axis - Major Grid and Tick lines',
        (WidgetTester tester) async {
      final _SplineAreaDateTime chartContainer =
          _splineAreaDateTime('datetime_gridlines') as _SplineAreaDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    //   final _SplineAreaDateTime chartContainer =
    //       _splineAreaDateTime('datetime_labelStyle') as _SplineAreaDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _SplineAreaDateTime chartContainer =
    //       _splineAreaDateTime('datetime_axisVisible') as _SplineAreaDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
...
StatelessWidget _splineAreaDateTime(String sampleName) {
  return _SplineAreaDateTime(sampleName);
}

// ignore: must_be_immutable
class _SplineAreaDateTime extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _SplineAreaDateTime(String sampleName) {
