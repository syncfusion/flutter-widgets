...
/// Test method of category axis of the spline area series.
void splineAreaCategoryAxis() {
  ...
  group('Category Axis - Default Area Series', () {
    testWidgets('Category axis - Default', (WidgetTester tester) async {
      final _SplineAreaCategory chartContainer =
          _splineAreaCategory('category_default') as _SplineAreaCategory;
  ...
  //     final _SplineAreaCategory chartContainer =
  //         _splineAreaCategory('category_labelPlacement') as _SplineAreaCategory;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  ...
  //     final _SplineAreaCategory chartContainer =
  //         _splineAreaCategory('category_EdgeLabelPlacement')
  //             as _SplineAreaCategory;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  //     final _SplineAreaCategory chartContainer =
  //         _splineAreaCategory('category_inversed') as _SplineAreaCategory;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  //     final _SplineAreaCategory chartContainer =
  //         _splineAreaCategory('category_opposed') as _SplineAreaCategory;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  group('Category- Area Axis Elements', () {
    testWidgets('Category Axis - Label and Tick Position',
        (WidgetTester tester) async {
      final _SplineAreaCategory chartContainer =
          _splineAreaCategory('category_label_tickPosition')
              as _SplineAreaCategory;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('Category Axis - Label Style', (WidgetTester tester) async {
      final _SplineAreaCategory chartContainer =
          _splineAreaCategory('category_labelStyle') as _SplineAreaCategory;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    //   final _SplineAreaCategory chartContainer =
    //       _splineAreaCategory('category_axisVisible') as _SplineAreaCategory;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('Category Axis - Axis Line', (WidgetTester tester) async {
      final _SplineAreaCategory chartContainer =
          _splineAreaCategory('category_axisLine_title') as _SplineAreaCategory;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
  ...
  group('Category - Area Grid and Ticks', () {
    testWidgets('Category Axis - Major Grid and Tick lines',
        (WidgetTester tester) async {
      final _SplineAreaCategory chartContainer =
          _splineAreaCategory('category_gridlines') as _SplineAreaCategory;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
...
StatelessWidget _splineAreaCategory(String sampleName) {
  return _SplineAreaCategory(sampleName);
}

// ignore: must_be_immutable
class _SplineAreaCategory extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _SplineAreaCategory(String sampleName) {
