...
/// Test method for date time axis of the stacked area 100 series.
void stackedArea100DateTimeAxis() {
  ...
  group('Stacked Area Date Time Axis - Defualt Properties', () {
    testWidgets('DateTime axis - Default', (WidgetTester tester) async {
      final _StackedArea100DateTime chartContainer =
          _stackedArea100DateTime('datetime_default')
              as _StackedArea100DateTime;
  ...
  //     final _StackedArea100DateTime chartContainer =
  //         _stackedArea100DateTime('datetime_range') as _StackedArea100DateTime;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  ...
  //     final _StackedArea100DateTime chartContainer =
  //         _stackedArea100DateTime('datetime_rangepadding_add')
  //             as _StackedArea100DateTime;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  //       (WidgetTester tester) async {
  //     final _StackedArea100DateTime chartContainer =
  //         _stackedArea100DateTime('datetime_rangepadding_normal')
  //             as _StackedArea100DateTime;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  //       (WidgetTester tester) async {
  //     final _StackedArea100DateTime chartContainer =
  //         _stackedArea100DateTime('datetime_rangepadding_round')
  //             as _StackedArea100DateTime;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  //       (WidgetTester tester) async {
  //     final _StackedArea100DateTime chartContainer =
  //         _stackedArea100DateTime('datetime_rangepadding_none')
  //             as _StackedArea100DateTime;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  //       (WidgetTester tester) async {
  //     final _StackedArea100DateTime chartContainer =
  //         _stackedArea100DateTime('datetime_rangepadding_auto')
  //             as _StackedArea100DateTime;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  //       (WidgetTester tester) async {
  //     final _StackedArea100DateTime chartContainer =
  //         _stackedArea100DateTime('datetime_edgelabelPlacement_hide')
  //             as _StackedArea100DateTime;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  ...
  group('Stacked area Date Time Axis Elements', () {
    testWidgets('DateTime Axis - Axis Line and Title',
        (WidgetTester tester) async {
      final _StackedArea100DateTime chartContainer =
          _stackedArea100DateTime('datetime_axisLine_title')
              as _StackedArea100DateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    //   final _StackedArea100DateTime chartContainer =
    //       _stackedArea100DateTime('datetime_inversed')
    //           as _StackedArea100DateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    //     (WidgetTester tester) async {
    //   final _StackedArea100DateTime chartContainer =
    //       _stackedArea100DateTime('datetime_opposed')
    //           as _StackedArea100DateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    testWidgets('Stacked area DateTime Axis - Major Grid and Tick lines',
        (WidgetTester tester) async {
      final _StackedArea100DateTime chartContainer =
          _stackedArea100DateTime('datetime_gridlines')
              as _StackedArea100DateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    //     (WidgetTester tester) async {
    //   final _StackedArea100DateTime chartContainer =
    //       _stackedArea100DateTime('datetime_labelStyle')
    //           as _StackedArea100DateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    //   final _StackedArea100DateTime chartContainer =
    //       _stackedArea100DateTime('datetime_axisVisible')
    //           as _StackedArea100DateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
...
StatelessWidget _stackedArea100DateTime(String sampleName) {
  return _StackedArea100DateTime(sampleName);
}

// ignore: must_be_immutable
class _StackedArea100DateTime extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _StackedArea100DateTime(String sampleName) {
