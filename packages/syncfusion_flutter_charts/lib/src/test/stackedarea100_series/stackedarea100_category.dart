...
/// Test method of category axis of the stacked area 100 series.
void stackedArea100CategoryAxis() {
  ...
  group('Stacked Area Category - Defualt Properties', () {
    testWidgets('Category axis - Default', (WidgetTester tester) async {
      final _StackedArea100Category chartContainer =
          _stackedArea100Category('category_default')
              as _StackedArea100Category;
...
// to test series count
    ...
    //   final _StackedArea100Category chartContainer =
    //       _stackedArea100Category('category_labelPlacement')
    //           as _StackedArea100Category;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
  ...
  group('Stacked Area Category - Axis Elements', () {
    ...
    //   final _StackedArea100Category chartContainer =
    //       _stackedArea100Category('category_EdgeLabelPlacement')
    //           as _StackedArea100Category;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    //   final _StackedArea100Category chartContainer =
    //       _stackedArea100Category('category_inversed')
    //           as _StackedArea100Category;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    //   final _StackedArea100Category chartContainer =
    //       _stackedArea100Category('category_opposed')
    //           as _StackedArea100Category;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    testWidgets('Category Axis - Label and Tick Position',
        (WidgetTester tester) async {
      final _StackedArea100Category chartContainer =
          _stackedArea100Category('category_label_tickPosition')
              as _StackedArea100Category;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('Category Axis - Major Grid and Tick lines',
        (WidgetTester tester) async {
      final _StackedArea100Category chartContainer =
          _stackedArea100Category('category_gridlines')
              as _StackedArea100Category;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    //   final _StackedArea100Category chartContainer =
    //       _stackedArea100Category('category_labelStyle')
    //           as _StackedArea100Category;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    ...
    testWidgets('Category Axis - Visibility', (WidgetTester tester) async {
      final _StackedArea100Category chartContainer =
          _stackedArea100Category('category_axisVisible')
              as _StackedArea100Category;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('Category Axis - Axis Line', (WidgetTester tester) async {
      final _StackedArea100Category chartContainer =
          _stackedArea100Category('category_axisLine_title')
              as _StackedArea100Category;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
...
StatelessWidget _stackedArea100Category(String sampleName) {
  return _StackedArea100Category(sampleName);
}

// ignore: must_be_immutable
class _StackedArea100Category extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _StackedArea100Category(String sampleName) {
