...
/// Test method for numeric axis of the bar series.
void barNumericAxis() {
  ...
  group('Bar Numeric - Range and Range Padding', () {
    testWidgets('Numeric axis - Default', (WidgetTester tester) async {
      final _BarNumeric chartContainer =
          _barNumeric('numeric_default') as _BarNumeric;
    ...
    //   final _BarNumeric chartContainer =
    //       _barNumeric('numeric_defaultData') as _BarNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    ...
    //   final _BarNumeric chartContainer =
    //       _barNumeric('numeric_range') as _BarNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _BarNumeric chartContainer =
    //       _barNumeric('numeric_rangePadding_Add') as _BarNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //     (WidgetTester tester) async {
    //   final _BarNumeric chartContainer =
    //       _barNumeric('numeric_rangePadding_Normal') as _BarNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //     (WidgetTester tester) async {
    //   final _BarNumeric chartContainer =
    //       _barNumeric('numeric_rangePadding_Round') as _BarNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //     (WidgetTester tester) async {
    //   final _BarNumeric chartContainer =
    //       _barNumeric('numeric_rangePadding_Auto') as _BarNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //     (WidgetTester tester) async {
    //   final _BarNumeric chartContainer =
    //       _barNumeric('numeric_rangePadding_None') as _BarNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
  ...
  // group('Bar Numeric - EdgeLabelPlacement', () {
  //   testWidgets('Numeric axis - EdgeLabelPlacement',
  //       (WidgetTester tester) async {
  //     final _BarNumeric chartContainer =
  //         _barNumeric('numeric_edgelabelPlacement_hide') as _BarNumeric;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  group('Bar Numeric - grids, Ticks and Axis Elements', () {
    testWidgets('Numeric Axis - Axis Line and Title',
        (WidgetTester tester) async {
      final _BarNumeric chartContainer =
          _barNumeric('numeric_axisLine_title') as _BarNumeric;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('Numeric axis - Inversed', (WidgetTester tester) async {
      final _BarNumeric chartContainer =
          _barNumeric('numeric_inversed') as _BarNumeric;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('Numeric axis - Opposed', (WidgetTester tester) async {
      final _BarNumeric chartContainer =
          _barNumeric('numeric_opposed') as _BarNumeric;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    testWidgets('Numeric Axis - Major Grid and Tick lines',
        (WidgetTester tester) async {
      final _BarNumeric chartContainer =
          _barNumeric('numeric_gridlines') as _BarNumeric;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    //   final _BarNumeric chartContainer =
    //       _barNumeric('numeric_labelStyle') as _BarNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _BarNumeric chartContainer =
    //       _barNumeric('numeric_axisVisible') as _BarNumeric;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
...
StatelessWidget _barNumeric(String sampleName) {
  return _BarNumeric(sampleName);
}

// ignore: must_be_immutable
class _BarNumeric extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _BarNumeric(String sampleName) {
