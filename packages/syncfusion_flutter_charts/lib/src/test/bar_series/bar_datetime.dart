...
/// Test method for date time axis of the bar series.
void barDateTimeAxis() {
  ...
  //     final _BarDateTime chartContainer =
  //         _barDateTime('datetime_default') as _BarDateTime;
  ...
  //     final _BarDateTime chartContainer =
  //         _barDateTime('datetime_range') as _BarDateTime;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  //     final _BarDateTime chartContainer =
  //         _barDateTime('datetime_rangepadding_add') as _BarDateTime;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  //       (WidgetTester tester) async {
  //     final _BarDateTime chartContainer =
  //         _barDateTime('datetime_rangepadding_normal') as _BarDateTime;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  //       (WidgetTester tester) async {
  //     final _BarDateTime chartContainer =
  //         _barDateTime('datetime_rangepadding_round') as _BarDateTime;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  //       (WidgetTester tester) async {
  //     final _BarDateTime chartContainer =
  //         _barDateTime('datetime_rangepadding_none') as _BarDateTime;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  //       (WidgetTester tester) async {
  //     final _BarDateTime chartContainer =
  //         _barDateTime('datetime_rangepadding_auto') as _BarDateTime;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  //       (WidgetTester tester) async {
  //     final _BarDateTime chartContainer =
  //         _barDateTime('datetime_edgelabelPlacement_hide') as _BarDateTime;
  //     await tester.pumpWidget(chartContainer);
  //     chart = chartContainer.chart;
  //     final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
  //     _chartState = key.currentState as SfCartesianChartState?;
  ...
  group('Bar Date Time - Grids, Ticks and Axis Elements', () {
    testWidgets('DateTime Axis - Axis Line and Title',
        (WidgetTester tester) async {
      final _BarDateTime chartContainer =
          _barDateTime('datetime_axisLine_title') as _BarDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    //   final _BarDateTime chartContainer =
    //       _barDateTime('datetime_inversed') as _BarDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _BarDateTime chartContainer =
    //       _barDateTime('datetime_opposed') as _BarDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    testWidgets('DateTime Axis - Major Grid and Tick lines',
        (WidgetTester tester) async {
      final _BarDateTime chartContainer =
          _barDateTime('datetime_gridlines') as _BarDateTime;
      await tester.pumpWidget(chartContainer);
      chart = chartContainer.chart;
    });
    ...
    //   final _BarDateTime chartContainer =
    //       _barDateTime('datetime_labelStyle') as _BarDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
    ...
    //   final _BarDateTime chartContainer =
    //       _barDateTime('datetime_axisVisible') as _BarDateTime;
    //   await tester.pumpWidget(chartContainer);
    //   chart = chartContainer.chart;
    //   final GlobalKey key = chart!.key as GlobalKey<State<StatefulWidget>>;
    //   _chartState = key.currentState as SfCartesianChartState?;
...
StatelessWidget _barDateTime(String sampleName) {
  return _BarDateTime(sampleName);
}

// ignore: must_be_immutable
class _BarDateTime extends StatelessWidget {
  // ignore: prefer_const_constructors_in_immutables
  _BarDateTime(String sampleName) {
