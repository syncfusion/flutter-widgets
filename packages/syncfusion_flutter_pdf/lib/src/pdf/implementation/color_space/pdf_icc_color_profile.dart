...
class _PdfICCColorProfile implements _IPdfWrapper {
  //Constructor
  //Initializes a new instance of the [PdfICCColorProfile] class.
  _PdfICCColorProfile() : super() {
    _stream.compress = true;
    _stream.setProperty(_DictionaryProperties.filter,
        _PdfName(_DictionaryProperties.flateDecode));
    _stream.setProperty(_DictionaryProperties.n, _PdfNumber(3));
    _stream._beginSave = _beginSaveStream;
  }
