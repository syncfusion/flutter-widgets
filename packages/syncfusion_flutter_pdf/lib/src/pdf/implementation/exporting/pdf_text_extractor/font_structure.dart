...
// text to get the expected text.
  ...
  String getLiteralString(String encodedText) {
    ...
    while ((decodedText.contains('\\') && (!decodedText.contains('\\\\'))) ||
        decodedText.contains('\u0000')) {
      String octalText = '';
      if (decodedText.contains('\\', octalIndex + 1)) {
