...
class _PdfCjkFontDescryptorFactory {
  static _PdfDictionary getFontDescryptor(
      PdfCjkFontFamily fontFamily, int fontStyle, _PdfFontMetrics fontMetrics) {
  ...
  static void fillHeiseiKakuGothicW5(_PdfDictionary fontDescryptor,
      int fontStyle, PdfCjkFontFamily fontFamily, _PdfFontMetrics fontMetrics) {
    final _Rectangle fontBBox = _Rectangle(-92, -250, 1102, 1175);
    final _Rectangle fontBBoxI = _Rectangle(-92, -250, 1102, 1932); //Italic
