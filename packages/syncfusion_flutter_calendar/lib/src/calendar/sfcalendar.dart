...
class SfCalendar extends StatefulWidget {
  ...
  ///      child: SfCalendar(
  ///      view: CalendarView.day,
  ///      customTodayButton: Image.asset("asset/icon.png"),
  ///      ),
  ///    );
  ///  }
  ///
  /// ```
  final Widget? customTodayButton;
...
class _SfCalendarState extends State<SfCalendar> with SingleTickerProviderStateMixin {
  ...
  SfCalendarThemeData _getThemeDataValue(SfCalendarThemeData calendarThemeData, ThemeData themeData) {
    ...
    return calendarThemeData.copyWith(
        ...
        activeDatesBackgroundColor: calendarThemeData.activeDatesBackgroundColor ?? effectiveThemeData.activeDatesBackgroundColor,
        todayBackgroundColor: calendarThemeData.todayBackgroundColor ?? effectiveThemeData.todayBackgroundColor,
        trailingDatesBackgroundColor: calendarThemeData.trailingDatesBackgroundColor ?? effectiveThemeData.trailingDatesBackgroundColor,
        leadingDatesBackgroundColor: calendarThemeData.leadingDatesBackgroundColor ?? effectiveThemeData.leadingDatesBackgroundColor,
        viewHeaderBackgroundColor: calendarThemeData.viewHeaderBackgroundColor ?? effectiveThemeData.viewHeaderBackgroundColor,
        allDayPanelColor: calendarThemeData.allDayPanelColor ?? effectiveThemeData.allDayPanelColor,
        weekNumberBackgroundColor: calendarThemeData.weekNumberBackgroundColor ?? effectiveThemeData.weekNumberBackgroundColor,
        ...
        blackoutDatesTextStyle: calendarThemeData.blackoutDatesTextStyle == null ? widget.blackoutDatesTextStyle : calendarThemeData.blackoutDatesTextStyle?.merge(widget.blackoutDatesTextStyle),
  ...
  void _updateVisibleAppointments() async {
    ...
    if (_view != CalendarView.schedule) {
      ...
      final List<CalendarAppointment> tempVisibleAppointment = AppointmentHelper.getVisibleAppointments(viewStartDate, viewEndDate, _appointments, widget.timeZone, _view == CalendarView.month || CalendarViewHelper.isTimelineView(_view));
      ...
      widgets.add(MouseRegion(
          ...
          child: GestureDetector(
            child: _ScheduleAppointmentView(
                header: CustomPaint(painter: _AgendaDateTimePainter(currentDate, null, widget.scheduleViewSettings, widget.todayHighlightColor ?? _calendarTheme.todayHighlightColor, widget.todayTextStyle, _locale, _calendarTheme, _themeData, _agendaDateNotifier, _minWidth, isRTL, _textScaleFactor, _isMobilePlatform), size: Size(viewPadding, appointmentViewHeaderHeight)),
                content: Container(
                  padding: EdgeInsets.fromLTRB(isRTL ? 0 : viewPadding, appointmentViewTopPadding, isRTL ? viewPadding : 0, appointmentViewTopPadding),
                  child: AgendaViewLayout(null, widget.scheduleViewSettings, currentDate, currentAppointments, isRTL, _locale, _localizations, _calendarTheme, _themeData, _agendaViewNotifier, widget.appointmentTimeTextFormat, viewPadding, _textScaleFactor, _isMobilePlatform, widget.appointmentBuilder, _minWidth - viewPadding, panelHeight, widget.monthViewSettings.agendaStyle.placeholderTextStyle, widget),
                )),
        ...
        child: Container(
            ...
            child: RepaintBoundary(
                child: headerWidget != null
                    ...
                    : CustomPaint(
                        painter: _ScheduleLabelPainter(startDate, endDate, widget.scheduleViewSettings, isMonthLabel, isRTL, _locale, _useMobilePlatformUI, _agendaViewNotifier, _calendarTheme, _themeData, _localizations, _textScaleFactor),
        ...
        child: GestureDetector(
          child: _ScheduleAppointmentView(
              ...
              content: Container(
                ...
                child: CustomPaint(painter: _ScheduleLabelPainter(currentDisplayDate, null, widget.scheduleViewSettings, false, isRTL, _locale, _useMobilePlatformUI, _agendaViewNotifier, _calendarTheme, _themeData, _localizations, _textScaleFactor, isDisplayDate: true), size: Size(_minWidth - viewHeaderWidth, displayDateHighlightHeight)),
              )),
          onTapUp: (TapUpDetails details) {
            _removeDatePicker();
        ...
        child: _PopupWidget(
            ...
            child: Container(
                ...
                child: Material(
                  ...
                  child: Scrollbar(thumbVisibility: showScrollbar, controller: calendarViewPopupScrollController, child: ListView(padding: EdgeInsets.zero, controller: calendarViewPopupScrollController, children: children)),
                ))));
  }
                  ...
                  child: GestureDetector(
                    child: ScrollConfiguration(
                      ...
                      child: ListView(padding: EdgeInsets.zero, physics: const ClampingScrollPhysics(), controller: _resourcePanelScrollController, children: <Widget>[
                        ResourceViewWidget(_resourceCollection, widget.resourceViewSettings, resourceItemHeight, widget.cellBorderColor, _calendarTheme, _themeData, _resourceImageNotifier, isRTL, _textScaleFactor, _resourceHoverNotifier.value, _imagePainterCollection, resourceViewSize, panelHeight, widget.resourceViewHeaderBuilder),
                      ]),
                    ),
                    onTapUp: (TapUpDetails details) {
            ...
            child: Container(
                ...
                child: MouseRegion(
                    ...
                    child: GestureDetector(
                      child: Stack(children: <Widget>[
                        CustomPaint(
                          painter: _AgendaDateTimePainter(currentSelectedDate, widget.monthViewSettings, null, widget.todayHighlightColor ?? _calendarTheme.todayHighlightColor, widget.todayTextStyle, _locale, _calendarTheme, _themeData, _agendaDateNotifier, _minWidth, isRTL, _textScaleFactor, _isMobilePlatform),
...
class _CalendarHeaderViewState extends State<_CalendarHeaderView> {
  ...
  Widget build(BuildContext context) {
    ...
    if (!widget.isMobilePlatform || (widget.isMobilePlatform && weekNumberEnabled)) {
      final Size headerTextSize = _getTextWidgetWidth(headerString, widget.height, widget.width - totalArrowWidth - todayIconWidth - padding, context, style: widget.calendarTheme.headerTextStyle);
                  ...
                  child: Container(
                      ...
                      child: Row(
                          ...
                          children: widget.showDatePickerButton
                              ...
                              : <Widget>[Flexible(child: Text(headerString, style: headerTextStyle, maxLines: 1, overflow: TextOverflow.clip, softWrap: false, textDirection: CalendarViewHelper.getTextDirectionBasedOnLocale(widget.locale)))])),
                )),
          )
        : Container(
            alignment: getHeaderAlignment(),
                  ...
                  child: Container(
                      ...
                      child: Row(
                        ...
                        children: widget.showDatePickerButton
                            ...
                            : <Widget>[
                                Flexible(child: Text(headerString, style: headerTextStyle, maxLines: 1, overflow: TextOverflow.clip, softWrap: false, textDirection: CalendarViewHelper.getTextDirectionBasedOnLocale(widget.locale))),
                              ],
                      )),
                )),
          );
                  ...
                  child: Semantics(
                    ...
                    child: useMobilePlatformUI
                        ? Container(
                            ...
                            height: headerHeight,
                            alignment: Alignment.center,
                            child: widget.customTodayButton ??
                                Icon(
                                  Icons.today,
                                  color: style.color,
                                  size: style.fontSize,
...
class _ScheduleLabelPainter extends CustomPainter {
  ...
  void _addDisplayDateLabel(Canvas canvas, Size size) {
    ...
    final TextSpan span = TextSpan(
      ...
      style: themeData.textTheme.bodyMedium!.merge(scheduleViewSettings.weekHeaderSettings.weekTextStyle ?? scheduleViewSettings.placeholderTextStyle),
    );
  ...
  void _addWeekLabel(Canvas canvas, Size size) {
    ...
    final TextSpan span = TextSpan(
      ...
      style: themeData.textTheme.bodyMedium!.copyWith(color: Colors.grey, fontSize: 15).merge(scheduleViewSettings.weekHeaderSettings.weekTextStyle),
    );
  ...
  void _addMonthLabel(Canvas canvas, Size size) {
    ...
    final TextSpan span = TextSpan(
      text: dateString,
      style: themeData.textTheme.bodyLarge!.copyWith(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w400).merge(scheduleViewSettings.monthHeaderSettings.monthTextStyle),
    );
...
class _AgendaDateTimePainter extends CustomPainter {
  _AgendaDateTimePainter(this.selectedDate, this.monthViewSettings, this.scheduleViewSettings, this.todayHighlightColor, this.todayTextStyle, this.locale, this.calendarTheme, this.themeData, this.agendaDateNotifier, this.viewWidth, this.isRTL, this.textScaleFactor, this.isMobilePlatform) : super(repaint: agendaDateNotifier);
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (monthViewSettings != null) {
      ...
      if (useMobilePlatformUI) {
        ...
        dayTextStyle = agendaDayThemeTextStyle.merge(scheduleViewSettings!.dayHeaderSettings.dayTextStyle ?? TextStyle(color: calendarTheme.agendaDayTextStyle?.color, fontSize: 9, fontWeight: FontWeight.w500));
        dateTextStyle = agendaDateThemeTextStyle.merge(scheduleViewSettings!.dayHeaderSettings.dateTextStyle ?? TextStyle(color: calendarTheme.agendaDateTextStyle?.color, fontSize: 18, fontWeight: FontWeight.normal));
      }
    }
    ...
    if (isToday) {
      ...
      dayTextStyle = todayTextStyle != null ? calendarTheme.todayTextStyle!.copyWith(fontSize: dayTextStyle.fontSize, color: todayTextColor) : dayTextStyle.copyWith(color: todayTextColor);
      dateTextStyle = todayTextStyle != null ? calendarTheme.todayTextStyle!.copyWith(fontSize: dateTextStyle.fontSize, color: todayTextStyleColor) : dateTextStyle.copyWith(color: todayTextStyleColor);
    }
  ...
  void _addDayLabelForMobile(Canvas canvas, Size size, double padding, TextStyle dayTextStyle, TextStyle dateTextStyle, bool isToday, bool isMobile) {
    ...
    if (agendaDateNotifier.value != null && isSameDate(agendaDateNotifier.value!.hoveringDate, selectedDate)) {
      if (xPosition < agendaDateNotifier.value!.hoveringOffset.dx && xPosition + _textPainter.width > agendaDateNotifier.value!.hoveringOffset.dx && yPosition < agendaDateNotifier.value!.hoveringOffset.dy && yPosition + _textPainter.height > agendaDateNotifier.value!.hoveringOffset.dy) {
        _linePainter.color = isToday ? Colors.black.withOpacity(0.1) : (themeData.brightness == Brightness.dark ? Colors.white : Colors.black87).withOpacity(0.04);
        _drawTodayCircle(canvas, xPosition, yPosition, padding);
      }
    }
