...
class ChartSerialization {
        ...
        builder.element(
          ...
          nest: () {
            ...
            final String positionStr =
                legendPostion == ExcelLegendPosition.bottom
                    ? 'b'
                ...
                nest: () {
                  builder.element(
                    ...
                    nest: () {
                      builder.attribute(
                        'id',
                        1024 + sheet.workbook.chartCount + chart.index,
                      );
                      builder.attribute(
                        'name',
                        'Chart ${sheet.workbook.chartCount + chart.index}',
                      );
                    },
                  );
                  ...
                  builder.element(
                    ...
                    nest: () {
                      ...
                      builder.element(
                        'a:r',
                        nest: () {
                          _serializeParagraphRunProperties(
                            builder,
                            chartTextArea,
                          );
                          builder.element(
  ...
  void _serializePlotArea(XmlBuilder builder, Chart chart) {
    builder.element(
      ...
      nest: () {
        ...
        _serializeFill(
          builder,
          chart.plotArea.linePattern,
          chart.plotArea.linePatternColor,
          false,
        );
      },
    );
    ...
    builder.element(
      ...
      nest: () {
        ...
        if (firstSerie.serieFormat.pieExplosionPercent != 0 ||
          ...
          builder.element(
            ...
            nest: () {
              builder.attribute(
                'val',
                firstSerie.serieFormat.pieExplosionPercent,
              );
            },
          );
        }
        ...
        if (firstSerie.linePattern != ExcelChartLinePattern.none) {
          _serializeFill(
            builder,
            firstSerie.linePattern,
            firstSerie.linePatternColor,
            true,
          );
        }
            ...
            nest: () {
              ...
              builder.element(
                ...
                nest: () {
                  builder.attribute(
                    'val',
                    firstSerie.dataLabels.isValue ? 1 : 0,
                  );
                },
              );
              builder.element(
                ...
                nest: () {
                  builder.attribute(
                    'val',
                    firstSerie.dataLabels.isCategoryName ? 1 : 0,
                  );
                },
              );
              builder.element(
                ...
                nest: () {
                  builder.attribute(
                    'val',
                    firstSerie.dataLabels.isSeriesName ? 1 : 0,
                  );
                },
              );
              builder.element(
              ...
              if (firstSerie.categoryLabels!.addressGlobal != '') {
                for (final Worksheet sheet
                    in firstSerie
                        ...
                        .worksheets
                        .innerList) {
                  if (firstSerie.categoryLabels!.addressGlobal.contains(
                        RegExp('${sheet.name}!'),
                      ) ||
                      firstSerie.categoryLabels!.addressGlobal.contains(
                        RegExp("${sheet.name}'!"),
                      )) {
                    tempSheet = sheet;
                    break;
            ...
            nest: () {
              builder.element(
                ...
                nest: () {
                  builder.element(
                    'c:f',
                    nest: firstSerie.values!.addressGlobal,
                  );
                  final Range firstRange = firstSerie.chart.worksheet
                      .getRangeByIndex(
                        firstSerie.values!.row,
                        firstSerie.values!.column,
                      );
                  Worksheet tempSheet = firstSerie.chart.worksheet;
                  if (firstSerie.values!.addressGlobal != '') {
                    for (final Worksheet sheet
                        in firstSerie
                            ...
                            .worksheets
                            .innerList) {
                      if (firstSerie.values!.addressGlobal.contains(
                            RegExp('${sheet.name}!'),
                          ) ||
                          firstSerie.values!.addressGlobal.contains(
                            RegExp("${sheet.name}'!"),
                          )) {
                        tempSheet = sheet;
                        break;
  ...
  void _serializeStringReference(
    XmlBuilder builder,
    String range,
    ChartSerie firstSerie,
    String tagName,
    ...
    builder.element(
      ...
      nest: () {
        ...
        for (int i = 0; i < chart.series.count; i++) {
          ...
          _serializeSerie(builder, firstSerie);
          pieSecondSize =
              firstSerie.serieFormat.commonSerieOptions.pieSecondSize;
          gapwidth = firstSerie.serieFormat.commonSerieOptions.gapWidth;
        }
  ...
  void _serializeCategoryAxisForStock(
    XmlBuilder builder,
    ChartCategoryAxis axis,
    int axisId,
    int crossAx,
    bool isBar,
  ) {
  ...
  void _serializeValueAxisForStockchart(
    XmlBuilder builder,
    ChartCategoryAxis axis,
    int axisId,
    int crossAx,
  ...
  void _serializeMarker(XmlBuilder builder, ChartSerie firstSerie) {
    ...
    if ((firstSerie.serieFormat.markerStyle == ExcelChartMarkerType.none) &&
      ...
      builder.element(
        ...
        ExcelChartMarkerType.none) {
      final String markerBackgroundColor = firstSerie
          .serieFormat
          .markerBackgroundColor
          .replaceAll('#', '');
      final String markerBorderColor = firstSerie.serieFormat.markerBorderColor
          .replaceAll('#', '');
  ...
  Future<void> _saveChartsAsync(Worksheet sheet) async {
    for (final Chart chart in (sheet.charts! as ChartCollection).innerList) {
      ...
      _addToArchiveAsync(
        bytes,
        'xl/charts/chart${sheet.workbook.chartCount}.xml',
      );
    }
  }
  ...
  Future<void> _serializeLegendAsync(
    ...
    builder.element(
      ...
      nest: () async {
        ...
        if (chartLegend.hasTextArea) {
          _serializeDefaultTextAreaPropertiesAsync(
            builder,
            chartLegend.textArea,
          );
        }
                  ...
                  builder.element(
                    ...
                    nest: () async {
                      ...
                      builder.element(
                        'a:r',
                        nest: () async {
                          _serializeParagraphRunPropertiesAsync(
                            builder,
                            chartTextArea,
                          );
                          builder.element(
  ...
  /// serializes string cache reference.
  Future<void> _serializeStringReferenceAsync(
    XmlBuilder builder,
    String range,
    ChartSerie firstSerie,
    String tagName,
    ...
    builder.element(
      ...
      nest: () async {
        ...
        builder.element(
          ...
          nest: () async {
            if (tagName == 'cat') {
              _serializeCategoryTagCacheValuesAsync(
                builder,
                firstSerie,
                dataSheet,
              );
  ...
  ///serialize stock axes
  Future<void> _serializeAxesforStockChartAsync(
    XmlBuilder builder,
    Chart chart,
    int axisId,
    int crossAx,
  ...
  ///Serialize catogory axis for stock chart
  Future<void> _serializeCategoryAxisForStockAsync(
    XmlBuilder builder,
    ChartCategoryAxis axis,
    int axisId,
    int crossAx,
  ...
  ///Serialize value axis for stock chart
  Future<void> _serializeValueAxisForStockchartAsync(
    XmlBuilder builder,
    ChartCategoryAxis axis,
    int axisId,
    int crossAx,
